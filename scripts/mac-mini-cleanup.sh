...
echo "1/16 — Removing authorized SSH keys..."
...
echo "2/16 — Restoring default sshd_config..."
...
# 3. Reload SSH daemon
echo "3/16 — Reloading SSH daemon..."
...
echo "5/16 — Killing bun run processes..."
...
echo "7/16 — Killing qdrant processes..."
...
echo "8/16 — Killing Vellum processes..."
...
echo "9/16 — Removing ~/.vellum directory..."
if [ -d ~/.vellum ]; then
    rm -rf ~/.vellum
    echo "      ✅ Removed ~/.vellum"
else
...
echo "10/16 — Killing embedding worker processes..."
...
echo "11/16 — Removing ~/.vellum.lock.json..."
...
echo "12/16 — Removing /Applications/Vellum.app..."
...
echo "13/16 — Removing ms-playwright browser caches..."
PW_FOUND=false
...
# 14. Clear Vellum desktop app UserDefaults
echo "14/16 — Clearing Vellum desktop app UserDefaults..."
...
# 15. Clear Vellum Sparkle auto-updater defaults
echo "15/16 — Clearing Vellum Sparkle updater defaults..."
...
# 16. Remove Vellum from the Dock
echo "16/16 — Removing Vellum from the Dock..."
