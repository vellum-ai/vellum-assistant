...
if (before === null) {
  console.error(
    "Error: avatar/character-components.json does not exist. Run `node scripts/avatar/generate-catalog.mjs` to create it.",
  );
  process.exit(1);
}
...
if (before !== after) {
  ...
  console.error(
    "Error: avatar/character-components.json is out of date. Run `node scripts/avatar/generate-catalog.mjs` to regenerate it.",
  );
  process.exit(1);
}

console.log("avatar/character-components.json is up to date.");
