...
| `cli/` | The `vellum` CLI |
| `clients/` | End-user app surfaces (web, iOS, macOS/Electron) |
...
### How Big Is Your Change? Check In Accordingly
...
- start a thread in the [#contributors](https://discord.com/channels/1471183263174234245/1503398277092081875) or [#dev](https://discord.com/channels/1471183263174234245/1471227264132845623) channel on Discord.

We expose multiple surfaces (roadmap, GitHub issues, Discord) so you can notify us through whichever medium is easiest for you. We consolidate everything on our end.
