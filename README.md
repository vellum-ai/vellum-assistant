...
| Area                       | Summary                                                                                                                                                                                                                                                                                                                  |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Trust engine**           | Every actor is resolved to guardian, trusted, or unknown, and that identity is enforced on every request. Unknown actors can't read memory, trigger tools, or escalate. Credentials are held in a separate process and never reach the model. |
