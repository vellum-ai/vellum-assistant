...
- `access_request` prompts carry their typed directives the same way: the request-code verify/trust/reject/block directive and the `"open invite flow"` phrase for starting the Trusted Contacts invite flow.
