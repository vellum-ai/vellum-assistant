...
| PR  | Scope                                                                                                                                                                                                                                | Status                            |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------- |
| 1   | Foundation: `finalized` column (migration 324), `content` union (`ContentBlock[] \| { ref }`), content resolver at the row-mapper chokepoint, in-flight JSONL format module (`message-content-file.ts`)                              | this PR                           |
