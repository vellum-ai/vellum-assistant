...
| Credential records  | CES `<cesDataRoot>/credential-records.json`            | Service, field, alias, policy (`allowedTools`, `allowedDomains`, `injectionTemplates`), timestamps. Served over CES RPC/HTTP.                                    |
