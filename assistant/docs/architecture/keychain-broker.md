...
| File                                                | Role                                                                                                                                                                                                                                                                                                                                          |
| --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `assistant/src/security/credential-backend.ts`      | `CredentialBackend` interface definition. Declares `get`, `set`, `delete`, `list` as the uniform contract for all storage backends.                                                                                                                                                                                                           |
| `assistant/src/security/keychain-backend.ts`        | `CredentialBackend` implementation backed by the keychain broker client. Adapts broker UDS calls to the backend interface.                                                                                                                                                                                                                    |
| `assistant/src/security/encrypted-store-backend.ts` | `CredentialBackend` implementation backed by the encrypted file store (`~/.vellum/protected/keys.enc`). Adapts `encrypted-store.ts` to the backend interface.                                                                                                                                                                                 |
