...
const VALID_OUTREACH_TYPES = new Set<OutreachType>([
  "sales",
  "recruiting",
  "marketing",
  "other",
      ...
      classifications: {
        ...
        items: {
          ...
          properties: {
            ...
            is_outreach: {
              type: "boolean",
              description: "Whether this is cold outreach",
            },
            outreach_type: {
              type: "string",
...
): Promise<OutreachClassification[]> {
...
export async function classifyOutreach(
  emails: EmailMetadata[],
): Promise<OutreachClassification[]> {
