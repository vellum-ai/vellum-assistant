 ...
 * template: `{{CUTOFF}}` always, and `{{CORE_PAGES_SECTION}}` per its flag gate
 * — so a prompt copied from the bundled source never leaks a raw placeholder,
 * and a customized prompt can opt into the managed section.
 */
