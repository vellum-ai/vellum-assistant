...
/**
 * Complex multi-step migrations that go beyond simple ALTER TABLE. Spread into
 * the boot migration list so each runs — and is checkpointed — as its own step.
 */
export const complexMigrationSteps: MigrationStep[] = [
  migrateJobDeferrals,
