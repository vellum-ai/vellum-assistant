...
import { migrateConversationsSurfacedAt } from "./278-conversations-surfaced-at.js";

function createTestDb() {
  const sqlite = new Database(":memory:");
  // Pre-278 shape: no surfaced_at column (trimmed to the columns the
...
describe("migration 278: conversations surfaced_at", () => {
