...
import { initQdrantClient, resolveQdrantUrl } from "../../persistence/embeddings/qdrant-client.js";
import { rawAll, rawGet, rawRun } from "../../persistence/raw-query.js";
import { conversations, memoryGraphNodes, memorySegments } from "../../persistence/schema/index.js";
...
export async function cleanupStaleItemVectors(): Promise<void> {
  ...
  let qdrant;
  try {
    qdrant = (await import("../../persistence/embeddings/qdrant-client.js")).getQdrantClient();
  } catch {
