...
function buildDynamicSkillWorkflowSection(
  ...
  lines.push(
    ...
    "1. Run `assistant skills search <query>` to find community skills. Results include install counts and security audit badges (Gen Agent Trust Hub, Socket, Snyk).",
    "2. Present the search results to the user, highlighting the security audit status. Audits show PASS (safe/low risk), WARN (medium risk), or FAIL (high/critical risk) for each provider.",
