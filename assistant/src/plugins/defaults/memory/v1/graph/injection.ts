// ---------------------------------------------------------------------------
// Memory Graph — v1 context-block assembly and injection-image resolution
//
// Injection tracking (`InContextTracker`) lives in
// `../../graph/in-context-tracker.ts` — it is kept on every tier.
// ---------------------------------------------------------------------------

import { optimizeImageForTransport } from "../../../../../agent/image-optimize.js";
import { loadImageRefData } from "../../graph/image-ref-utils.js";
