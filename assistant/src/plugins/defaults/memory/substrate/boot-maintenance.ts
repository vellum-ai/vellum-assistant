// ---------------------------------------------------------------------------
// Memory substrate — daemon-startup helpers
// ---------------------------------------------------------------------------
//
...
const log = getLogger("boot-maintenance");
 ...
 * (`maybeSeedCapabilitySkills` / `maybeSeedCliCommandCards`) seconds after
 ...
 * `maybeSeedCapabilitySkills` call can race ahead of the corpus-stats build —
