// ---------------------------------------------------------------------------
// Memory substrate — Qdrant collection for concept pages
// ---------------------------------------------------------------------------
//
...
// FROZEN: persisted Qdrant collection name — never rename the value.
 ...
 */
// FROZEN: on-disk sentinel filename — never rename the value.
