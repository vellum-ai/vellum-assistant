...
export const SKILLS_INJECTION_CATALOG_HINT =
  "These skill cards describe availability, not tool instructions. Use skill_load to load a skill's current instructions and input schemas before calling its tools; follow those schemas over remembered arguments. Injected skills are only ones currently in the workspace. Run `assistant plugins search <name>` and `assistant skills search <name>` before concluding a given integration or skill is unsupported";
