...
const DESCRIPTION = [
  ...
  "",
  "Open every turn with a quick call, before any planning or tool work: a",
  "short acknowledgement, or the answer itself when you already have it, so",
  "the user is not waiting on silence. Think and work after that, and call",
  "again only when there is something new: a question, a progress note, the",
  "result.",
  "",
