...
export const uiShowTool = {
  ...
  description:
    ...
    "- oauth_connect: { providerKey, displayName?, description?, logoUrl?, requestedScopes?, connectLabel? }. Shows a managed OAuth connection CTA in chat; use when the current task needs a managed integration account (Google, Linear, GitHub, etc.) instead of asking the user to visit settings or attempting OAuth through shell/tools.\n" +
