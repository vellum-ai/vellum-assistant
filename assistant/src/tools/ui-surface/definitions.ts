...
export const uiShowTool = {
  ...
  description:
    ...
    "- oauth_connect: { providerKey, displayName?, description?, logoUrl?, connectLabel? }. Shows a managed OAuth connection CTA in chat; use when the current task needs a managed integration account (Google, Linear, GitHub, etc.) instead of asking the user to visit settings or attempting OAuth through shell/tools. Do not include OAuth scopes in the surface; managed providers use the platform's configured scopes.\n" +
