...
export const sendReactionTool = {
  name: "send_reaction",
  description: [
    "React to the user's latest message with a single emoji. Default to",
    "reacting when there's any emotional beat — acknowledge, celebrate,",
    "mock, agree, push back, vibe. Skip only when the message is purely",
    "informational or you're already mid-task and it would feel redundant.",
    "One per message.",
    "",
