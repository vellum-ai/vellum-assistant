...
import { backfillInstallationIdMigration } from "../workspace/migrations/010-backfill-installation-id.js";
...
describe("010-backfill-installation-id migration", () => {
  beforeEach(() => {
  ...
  test("has migration id 010-backfill-installation-id", () => {
    expect(backfillInstallationIdMigration.id).toBe(
      "010-backfill-installation-id",
    );
  });
});
