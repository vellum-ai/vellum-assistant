...
import { collapseBuiltinProfilesToOverridesMigration } from "../workspace/migrations/100-collapse-builtin-profiles-to-overrides.js";
...
describe("100-collapse-builtin-profiles-to-overrides migration", () => {
  test("has correct migration id", () => {
    expect(collapseBuiltinProfilesToOverridesMigration.id).toBe(
      "100-collapse-builtin-profiles-to-overrides",
    );
  });
