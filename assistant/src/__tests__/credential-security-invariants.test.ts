...
describe("Invariant 2: no generic plaintext secret read API", () => {
  ...
  test("secure-keys is only imported by authorized modules", () => {
    ...
    const ALLOWED_IMPORTERS = new Set([
      ...
      "plugin-api/resolve-credential.ts", // plugin-facing resolveCredential — reveal-equivalent plaintext read, scoped to the in-context plugin's own service or field
