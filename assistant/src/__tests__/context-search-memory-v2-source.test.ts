...
import type { EdgeIndex } from "../plugins/defaults/memory/substrate/edge-index.js";
import type { ConceptPage } from "../plugins/defaults/memory/substrate/types.js";
...
mock.module("../plugins/defaults/memory/substrate/edge-index.js", () => ({
