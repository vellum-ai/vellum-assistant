...
import { seedMainAgentOpusCallsiteMigration } from "../workspace/migrations/048-seed-main-agent-opus-callsite.js";
...
describe("048-seed-main-agent-opus-callsite migration", () => {
  test("has correct migration id", () => {
    expect(seedMainAgentOpusCallsiteMigration.id).toBe(
      "048-seed-main-agent-opus-callsite",
    );
  });
