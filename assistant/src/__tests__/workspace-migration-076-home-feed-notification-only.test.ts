/**
 * Tests for workspace migration `068-home-feed-notification-only`.
 *
...
import { homeFeedNotificationOnlyMigration } from "../workspace/migrations/076-home-feed-notification-only.js";
...
describe("workspace migration 068-home-feed-notification-only", () => {
