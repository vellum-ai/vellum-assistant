...
describe("relay-server", () => {
  ...
  test("invite redemption success: empty contact displayName triggers neutral 'Hi there' greeting", async () => {
    ...
    expect(
      // generic-examples:ignore-next-line — reason: test asserts token does not contain this specific phone number
    ...
    mockGuardianDeliveryList = [
      {
        channelType: "phone",
        status: "active",
        // generic-examples:ignore-next-line — reason: test fixture for relay contact
        address: "+15550000001",
        displayName: "Bob",
      },
    ];
