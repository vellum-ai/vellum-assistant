...
import { repairRenamedFireworksDeepseekProModelIdMigration } from "../workspace/migrations/151-repair-renamed-fireworks-deepseek-pro-model-id.js";
import { WORKSPACE_MIGRATIONS } from "../workspace/migrations/registry.js";
import { assertNotLiveDb } from "./assert-not-live-db.js";

const STALE = "accounts/fireworks/models/deepseek-v4-pro";
const REPLACEMENT = "accounts/fireworks/models/deepseek-v4-pro-0813";
...
describe("151-repair-renamed-fireworks-deepseek-pro-model-id migration", () => {
  test("has correct migration id and is registered", () => {
    expect(repairRenamedFireworksDeepseekProModelIdMigration.id).toBe(
      "151-repair-renamed-fireworks-deepseek-pro-model-id",
    );
  ...
  test("repairs the stale ID in default, call sites, and profiles", () => {
    ...
    repairRenamedFireworksDeepseekProModelIdMigration.run(workspaceDir);
