...
- **Edit** an existing skill by scaffolding over it (replaces the body; frontmatter fields you leave out keep their current values, and an empty value clears one)
