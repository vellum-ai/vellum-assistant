...
Determine whether the user has browser automation available (macOS desktop app) or is on a non-interactive channel (Telegram, etc.).
...
# Path A: Manual Setup for Channels (Telegram, etc.)
