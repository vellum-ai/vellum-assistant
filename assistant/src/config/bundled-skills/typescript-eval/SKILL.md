...
- **After successful test:** After explicit user consent, persist with `assistant skills create <skill-id> --name "<name>" --description "<description>" --body-file <path-or-stdin>` (use `-` for stdin).
