...
- `vellum credentials` — Collect API keys securely (for ElevenLabs TTS)
...
2. Use `vellum credentials` with `action: "prompt"`, `service: "elevenlabs"`, `field: "api_key"` to show a secure input dialog.
