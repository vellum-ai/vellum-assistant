...
| `services.tts.provider`                             | Active TTS provider for speech synthesis                                                                                      | `elevenlabs`                                                                                             |
| `services.tts.providers.elevenlabs.voiceId`         | ElevenLabs voice ID used by both in-app TTS and phone calls. Set during setup from the curated voice list. Defaults to Amelia | `ZF6FPAbjXT4488VcRRnw`                                                                                   |
| `services.tts.providers.elevenlabs.voiceModelId`    | Optional Twilio ConversationRelay model suffix. Leave empty to send bare `voiceId`                                            | _(empty)_                                                                                                |
| `services.tts.providers.elevenlabs.speed`           | Playback speed (`0.7` – `1.2`)                                                                                                | `1.0`                                                                                                    |
| `services.tts.providers.elevenlabs.stability`       | Voice stability (`0.0` – `1.0`)                                                                                               | `0.5`                                                                                                    |
| `services.tts.providers.elevenlabs.similarityBoost` | Voice similarity boost (`0.0` – `1.0`)                                                                                        | `0.75`                                                                                                   |
