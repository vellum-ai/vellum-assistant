...
function isToolUseBlock(block: unknown): block is Anthropic.ToolUseBlockParam {
  return typeof block === 'object' && block !== undefined && (block as { type: string }).type === 'tool_use';
}
...
function isToolResultBlock(block: unknown): block is Anthropic.ToolResultBlockParam {
  return typeof block === 'object' && block !== undefined && (block as { type: string }).type === 'tool_result';
}
