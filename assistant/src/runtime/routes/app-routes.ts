  ...
  return [
    {
      ...
      method: "GET",
      policyKey: "apps/dist",
      summary: "Serve a static file from an app dist directory",
      tags: ["apps"],
      handler: ({ params }) =>
    ...
    },
    {
      endpoint: "apps/share",
      method: "POST",
      summary: "Create a shareable link for an app bundle",
      tags: ["apps"],
    ...
    },
    {
      ...
      summary: "Get metadata for a shared app",
      tags: ["apps"],
    ...
    },
    {
      ...
      summary: "Download a shared app bundle",
      tags: ["apps"],
    ...
    },
    {
      ...
      method: "DELETE",
      policyKey: "apps/shared",
      summary: "Delete a shared app link",
      tags: ["apps"],
