...
function maybeApplyByokOnboarding(provider: string): void {
  ...
  try {
    ...
    const llm =
      llmValue !== null && typeof llmValue === "object" && !Array.isArray(llmValue)
        ? (llmValue as Record<string, unknown>)
        : ((raw.llm = {} as Record<string, unknown>) as Record<string, unknown>);
    ...
    const llmDefault =
      ...
      !Array.isArray(defaultValue)
        ...
        : ((llm.default = {} as Record<string, unknown>) as Record<string, unknown>);
