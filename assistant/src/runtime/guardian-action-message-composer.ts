...
export const GUARDIAN_ACTION_COPY_SYSTEM_PROMPT =
  ...
  "These messages are spoken aloud or sent as text, so use a warm, human tone. " +
...
export function buildGuardianActionGenerationPrompt(
  ...
  return [
    ...
    "These messages are for voice call scenarios and may be spoken aloud or sent as text.",
