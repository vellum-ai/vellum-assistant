...
import { migrateCreateMemoryRetrospectiveSkillMonitoring } from "./migrations/378-create-memory-retrospective-skill-monitoring.js";
...
export const migrationSteps: MigrationStep[] = [
  ...
  migrateCreateMemoryRetrospectiveSkillMonitoring,
];
