 ...
 * `onboarding_events` (migration 329), and `auth_fallback_events`
 * (migration 330). Rows are inserted at emit time and read only by the usage
 ...
 * move unchanged.
 *
 * Like migrations 297/298/326/329/330 the move is incremental: create the
