/**
 * Credential broker — issues single-use tokens for policy-checked credential access.
 *
...
import { getLogger, getSecureKey } from "./deps.js";
...
// ---------------------------------------------------------------------------
// Broker types (consolidated from broker-types.ts)
// ---------------------------------------------------------------------------
