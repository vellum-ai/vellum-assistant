...
export const renameConversationRoute: IpcRoute = {
  ...
  handler: async (params) => {
    ...
    // Broadcast title update so the client viewing this conversation
    // refreshes in-place, matching the HTTP rename route behavior.
    assistantEventHub
      .publish(
        buildAssistantEvent(
    ...
    // Notify all connected clients so sidebars refresh.
    assistantEventHub
      .publish(
