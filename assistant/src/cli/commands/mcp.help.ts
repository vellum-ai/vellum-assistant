...
server. On web, emits an open_url directive that the connected client handles
automatically: the web client opens the page via dispatchOpenUrl, and if the
popup is blocked, shows an "Open page" toast for manual fallback. The running
