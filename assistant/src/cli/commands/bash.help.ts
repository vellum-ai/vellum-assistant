...
and platform shell the bash tool uses for tool-call subprocesses. CES HTTP
credentials (CES_SERVICE_TOKEN, CES_CREDENTIAL_URL) and workspace paths are
forwarded. The command does not go through the assistant HTTP or IPC
