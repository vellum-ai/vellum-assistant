...
- Secrets: type_env_var — type the value of an environment variable into an input field without exposing the secret. Accepts an optional element_id to click-to-focus before typing. Available env vars: ANTHROPIC_API_KEY, E2E_GMAIL_TEST_USER_PASSWORD, TWILIO_AUTH_TOKEN, TWILIO_ACCOUNT_SID, NGROK_AUTH_TOKEN.
