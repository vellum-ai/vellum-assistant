...
import { compareMatchSpecificity, type HostMatchKind, matchHostPattern } from './host-pattern-match.js';
import type { CredentialInjectionTemplate, PolicyDecision, RequestTargetContext } from './types.js';
