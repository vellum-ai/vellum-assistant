...
public enum GatewayHTTPClient {
    ...
    public static func get(path: String, params: [String: String]? = nil, timeout: TimeInterval = 30, quiet: Bool = false, assistantId: String? = nil) async throws -> Response {
        return try await executeWithRetry(path: path, params: params, method: "GET", timeout: timeout, quiet: quiet, assistantId: assistantId)
    }
    ...
    public static func get<T: Decodable>(
        ...
        let response = try await get(path: path, params: params, timeout: timeout, assistantId: assistantId)
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func post(path: String, body: Data? = nil, params: [String: String]? = nil, contentType: String? = nil, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        return try await executeWithRetry(path: path, params: params, method: "POST", timeout: timeout, assistantId: assistantId) { request in
    ...
    public static func post(path: String, json: [String: Any], extraHeaders: [String: String]? = nil, timeout: TimeInterval = 30, skipRetry: Bool = false, assistantId: String? = nil) async throws -> Response {
        let body = try JSONSerialization.data(withJSONObject: json)
        return try await executeWithRetry(path: path, method: "POST", timeout: timeout, skipRetry: skipRetry, assistantId: assistantId) { request in
            request.httpBody = body
            if let extraHeaders {
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func patch(path: String, body: Data? = nil, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        return try await executeWithRetry(path: path, method: "PATCH", timeout: timeout, assistantId: assistantId) { request in
            request.httpBody = body
        }
    }
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, serialization errors, or network errors.
    public static func patch(path: String, json: [String: Any], timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        let body = try JSONSerialization.data(withJSONObject: json)
        return try await patch(path: path, body: body, timeout: timeout, assistantId: assistantId)
    }
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func put(path: String, body: Data? = nil, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        return try await executeWithRetry(path: path, method: "PUT", timeout: timeout, assistantId: assistantId) { request in
            request.httpBody = body
        }
    }
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, serialization errors, or network errors.
    public static func put(path: String, json: [String: Any], timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        let body = try JSONSerialization.data(withJSONObject: json)
        return try await put(path: path, body: body, timeout: timeout, assistantId: assistantId)
    }
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func delete(path: String, body: Data? = nil, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        return try await executeWithRetry(path: path, method: "DELETE", timeout: timeout, assistantId: assistantId) { request in
            request.httpBody = body
        }
    }
    ...
    /// - Returns: A `Response` with the raw data and HTTP status code.
    /// - Throws: `ClientError` if the request cannot be constructed, serialization errors, or network errors.
    public static func delete(path: String, json: [String: Any], timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> Response {
        let body = try JSONSerialization.data(withJSONObject: json)
        return try await delete(path: path, body: body, timeout: timeout, assistantId: assistantId)
    }
    ...
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func download(path: String, params: [String: String]? = nil, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> DownloadResponse {
        let connection = try resolveConnection(assistantId: assistantId)
        ...
        let freshConnection = try resolveConnection(assistantId: assistantId)
    ...
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func stream(path: String, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> (URLSession.AsyncBytes, URLResponse) {
        let connection = try resolveConnection(assistantId: assistantId)
    ...
    /// - Returns: A tuple of `(URLSession.AsyncBytes, URLResponse)` for streaming consumption.
    /// - Throws: `ClientError` if the request cannot be constructed, or network errors from `URLSession`.
    public static func streamPost(path: String, body: Data, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> (URLSession.AsyncBytes, URLResponse) {
        let connection = try resolveConnection(assistantId: assistantId)
    ...
    public static func streamPostWithRetry(path: String, body: Data, timeout: TimeInterval = 30, assistantId: String? = nil) async throws -> (URLSession.AsyncBytes, URLResponse) {
        let connection = try resolveConnection(assistantId: assistantId)
        var request = try buildRequest(path: path, params: nil, method: "POST", timeout: timeout, connection: connection)
        request.setValue("text/event-stream", forHTTPHeaderField: "Accept")
        request.httpBody = body
    ...
    ///
    /// - Parameter assistantId: When non-nil, looks up this specific assistant
    ///   instead of reading `connectedAssistantId` from UserDefaults. This
    ///   allows callers to target a different assistant without mutating
    ///   global state (replacing the unsafe temp-swap pattern).
    private static func resolveConnectedAssistant(assistantId override: String? = nil) -> LockfileAssistant? {
        let id: String
        if let override, !override.isEmpty {
            id = override
        } else {
            guard let storedId = UserDefaults.standard.string(forKey: "connectedAssistantId"), !storedId.isEmpty else { return nil }
            id = storedId
        }
    ...
    private static func resolveConnection(assistantId: String? = nil) throws -> ConnectionInfo {
        #if os(macOS)
        guard let assistant = resolveConnectedAssistant(assistantId: assistantId) else {
    ...
    public static func isConnectionManaged(assistantId: String? = nil) throws -> Bool {
        return try resolveConnection(assistantId: assistantId).isManaged
    }
    ...
    public static func buildURL(path: String, params: [String: String]? = nil, assistantId: String? = nil) throws -> URL {
        let connection = try resolveConnection(assistantId: assistantId)
