...
///
/// Extracted from ChatViewModel to reduce VM size. All ChatViewModel state is
/// accessed through the `MessageSendCoordinatorDelegate` protocol, avoiding
/// a direct reference back to the view model.
@MainActor
