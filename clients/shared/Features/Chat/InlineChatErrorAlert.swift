...
public struct InlineChatErrorAlert: View {
    ...
    private var accentColor: Color {
        switch category {
        case .rateLimit, .managedRateLimit, .providerOverloaded, .providerNetwork, .contextTooLarge, .providerOrdering, .providerWebSearch:
    ...
    private var icon: VIcon {
        ...
        case .managedRateLimit: return .clockAlert
    ...
    private var categoryTitle: String {
        ...
        case .managedRateLimit: return "Vellum Usage Limit"
