...
public final class AuthManager {
    ...
    public func checkSession() async {
        ...
        do {
            ...
            log.error("Session check failed: baseURL=\(authService.baseURL, privacy: .public) error=\(error.localizedDescription, privacy: .public)")
            state = .unauthenticated
        }
    }
    ...
    public func startWorkOSLogin() async {
        ...
        do {
            ...
            log.error("WorkOS login failed: baseURL=\(authService.baseURL, privacy: .public) error=\(error.localizedDescription, privacy: .public)")
    ...
    public func logout() async {
        do {
            ...
            log.error("Logout request failed: baseURL=\(authService.baseURL, privacy: .public) error=\(error.localizedDescription, privacy: .public)")
        }
