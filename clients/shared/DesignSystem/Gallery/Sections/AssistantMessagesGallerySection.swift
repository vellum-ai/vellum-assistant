        ...
        VStack(alignment: .leading, spacing: VSpacing.xxl) {
            ...
            if filter == nil || filter == "completedSurfaceChip" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Compact chip replacing an interactive surface after the user completes it. Uses surfaceOverlay at 0.5 opacity."
                )
            ...
            if filter == nil || filter == "inlineFallbackChip" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Placeholder shown when an inline surface type is unsupported. Uses surfaceOverlay at 0.5 opacity."
                )
            ...
            if filter == nil || filter == "commandListBubble" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Rendered when the assistant outputs a parseable command list. Uses surfaceOverlay as a solid background."
                )
            ...
            if filter == nil || filter == "modelListBubble" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Rendered when the assistant lists available models. Uses surfaceOverlay as a solid background."
                )
            ...
            if filter == nil || filter == "toolCallProgressBar" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Horizontal progress bar with clickable steps. Uses surfaceOverlay as a solid background."
                )
            ...
            if filter == nil || filter == "currentStepIndicator" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Shows current step name with a spinner or checkmark. Uses surfaceOverlay as a solid background."
                )
            ...
            if filter == nil || filter == "typingIndicator" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Animated three-dot indicator. Uses surfaceOverlay as a solid background."
                )
            ...
            if filter == nil || filter == "subagentStatusChip" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Status chip for subagent progress. Uses surfaceOverlay at 0.3 opacity."
                )
            ...
            if filter == nil || filter == "subagentConversation" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Threaded conversation indicator for subagents. Uses surfaceOverlay at 0.2/0.5 opacity (hover)."
                )
            ...
            if filter == nil || filter == "formSurface" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Interactive form with fields. The security info pill uses surfaceOverlay at 0.5 opacity when password fields are present."
                )
            ...
            if filter == nil || filter == "fileUploadSurface" {
                ...
                GallerySectionHeader(
                    ...
                    description: "File upload drop zone with file list. File chips use surfaceOverlay as a solid background. macOS only."
                )
            ...
            if filter == nil || filter == "imageEmbedPlaceholder" {
                ...
                GallerySectionHeader(
                    ...
                    description: "Skeleton placeholder shown while an image is loading. Uses surfaceOverlay as a solid fill. The actual image loads asynchronously on appear."
                )
