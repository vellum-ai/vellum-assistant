...
| `helper.hotkey` (voice mode chord, registration state)                | `preload/features/dictation.ts`, `main/features/push-to-talk.ts`, `native/.../PushToTalkService.cs`    | `native/mac-helper` (Fn)                    | `main/push-to-talk.test.ts`, `native/Vellum.WindowsHelper.Tests`                |
