...
| `screenRecording`                                                     | `preload/features/screen-recording.ts`, `main/features/screen-recording.ts`                           | shared Electron recording capability     | `preload/bridge-parity.test.ts`, `@vellumai/electron-desktop` recording tests   |
