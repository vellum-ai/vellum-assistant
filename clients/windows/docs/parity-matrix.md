...
| App control (`host_app_control`, per-window raw input and capture)  | `main/features/computer-use-actions.ts`, `native/Vellum.WindowsHelper/Modules/AppControl.cs`         | `main/computer-use-actions-feature.test.ts`, `native/Vellum.WindowsHelper.Tests/AppControlTests.cs`               |
