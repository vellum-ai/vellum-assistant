...
test("adds host_cu and host_app_control when the computer-use capability is installed", () => {
  ...
  // THEN the daemon sees both executors and teardown is routed to the helper shutdown
  expect(Object.keys(runtime.executors).sort()).toEqual([
    "host_app_control",
    "host_bash",
    "host_browser",
