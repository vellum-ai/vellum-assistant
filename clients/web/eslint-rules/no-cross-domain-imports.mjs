 ...
 *
 * Each folder under `clients/web/src/domains/` is meant to be a
 ...
 *
 * See `clients/web/docs/CONVENTIONS.md` → "How to decide where the
...
export const noCrossDomainImports = {
  meta: {
    ...
    docs: {
      description:
        "Disallow cross-domain imports between clients/web/src/domains/<x>/ peers.",
    },
    schema: [],
    messages: {
      crossDomain:
