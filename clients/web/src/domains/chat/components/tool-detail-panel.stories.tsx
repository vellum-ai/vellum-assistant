 ...
 * | Managed workspace tools | generic | mixed | ManagedWorkspaceTool | Nested-object inputs are the hardest shape for the parameter rows: each nested value renders as its own JSON block under its key. |
 ...
 * | Nested JSON input | ManagedWorkspaceTool, UnknownThirdPartyTool | A structured parameter renders as its own JSON block under its key. |
...
/**
 * A managed workspace tool. Its nested-object parameter renders as JSON under
 * its key, the hardest shape for the parameter rows.
 */
