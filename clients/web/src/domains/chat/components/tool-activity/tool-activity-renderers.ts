...
import { FileWriteDetail } from "@/domains/chat/components/tool-activity/file-write-detail";
...
const RENDERERS: Record<string, ToolActivityRenderer> = {
  ...
  // A write carries the file in its input, which the generic body would print
  // as an escaped JSON string. Its sibling shows a diff; this shows content.
  file_write: { Component: FileWriteDetail, ownsOutput: false },
  host_file_write: { Component: FileWriteDetail, ownsOutput: false },
