      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-[var(--app-spacing-sm)]">
          ...
          <Toggle
            ...
            className="[&_[role=switch][aria-checked=true]>span]:bg-[var(--avatar-accent-glyph,var(--aux-white))] [&_[role=switch][aria-checked=true]]:bg-[var(--avatar-accent,var(--system-positive-strong))]"
          />
          {showsBulkActions ? (
            <ActionMenu.Root>
