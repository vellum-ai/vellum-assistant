...
import { BrowserNotificationSettingsCard } from "@/domains/settings/components/browser-notification-settings-card";
...
export function NotificationsPage() {
  ...
  if (!isNativeAndroid && !isBrowserNotificationHost()) {
