 ...
 * holding a single card, so the only way to pay cannot be removed from here.
 * A second card brings it back, and it is always present with the flag off.
 */
...
/**
 * The default row: the brand run through `brandLabel` so the raw Stripe
 * string reads as "Visa", the last four digits, and both actions.
 */
