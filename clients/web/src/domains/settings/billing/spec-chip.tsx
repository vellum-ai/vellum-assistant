 ...
 * fit and wraps the rest onto the next line rather than squeezing a label
 * mid-pill. The `max-w-full` cap is the one exception: a chip too long for the
 * row on its own wraps inside the pill instead of overflowing the tile.
 */
