...
export const routes = {
  ...
  onboarding: {
    ...
    // SPIKE — research-onboarding / checkin-onboarding front doors. Reachable
    // on demand behind their default-off flags (see routes.tsx).
    research: r("/assistant/onboarding/research"),
    checkin: r("/assistant/onboarding/checkin"),
  },
