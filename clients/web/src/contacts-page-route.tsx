...
export function ContactsPageRoute() {
  ...
  // left names nothing under the one arriving. The detail route falls back to
  // the list; a deep link into the assistant already active is untouched,
  // because the first render records the id rather than acting on it.
  useEffect(() => {
  ...
  }, [assistantId, contactId, navigate]);
