/**
 * The mobile About Assistant sections as the app assembles them: a section
 * page fills `IntelligenceLayout`'s slots, the layout publishes either the
 * complete mobile top bar or just a section title, and the real
 * `ChatLayoutHeader` renders what it published above the page body.
 *
 ...
 * header draws: the gutter the bar and the page body share, the pill fills,
 * and the two bar modes beside each other. Schedules is the second mode, and
 * it is what every section that does not own the bar looks like.
 *
...
/** Library, the other section that owns the bar, with its import action. */
...
/**
 * Schedules does not own the bar, so the header keeps its default mobile
 * chrome: the drawer's hamburger, the section title the layout registers into
 * the centre slot, and search. Every section outside Contacts and Library
 * looks like this.
 */
