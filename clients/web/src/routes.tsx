...
export const routeTree = [
  ...
  // its job is to obtain the first in-memory gateway access token.
  {
    ...
    lazy: {
      Component: () =>
        import("@/domains/remote-web/pairing-page").then(
          (m) => m.RemoteWebPairingPage,
        ),
    },
  },
  ...
  // request body, is the only authorization the gateway needs.
  {
    ...
    lazy: {
      Component: () =>
        import("@/domains/credential-requests/credential-entry-page").then(
          (m) => m.CredentialEntryPage,
        ),
    },
  },
  ...
  // as About.
  {
    ...
    lazy: {
      Component: () =>
        import("@/components/theme-stage-page").then((m) => m.ThemeStagePage),
    },
  },
      ...
      // middleware, RootLayout render) — not for child-route errors.
      {
        ...
        children: [
          ...
          // onboarded users away. Visit `/assistant/onboarding/research`.
          {
            ...
            lazy: {
              Component: () =>
                import("@/domains/onboarding/pages/research-onboarding-route").then(
                  (m) => m.ResearchOnboardingRoute,
                ),
            },
          },
          ...
          // running the real job. Static fixtures + local state.
          {
            ...
            lazy: {
              Component: () =>
                import("@/domains/chat/onboarding-research/research-mock-page").then(
                  (m) => m.ResearchMockPage,
                ),
            },
          },
          {
          ...
          // Onboarding funnel — new-user setup flow (privacy → prechat → hatching).
          {
            ...
            children: [
              ...
              },
              {
                ...
                lazy: {
                  Component: () =>
                    import("@/domains/onboarding/pages/start-screen").then(
                      (m) => m.StartScreen,
                    ),
                },
              },
          ...
          // redirect. The page gates on the session-only platform gate itself.
          {
            ...
            lazy: {
              Component: () =>
                import("@/domains/settings/billing/checkout-page").then(
                  (m) => m.CheckoutPage,
                ),
            },
          },
          ...
          // self_hosted, so route components can use useActiveAssistantId().
          {
            ...
            children: [
              ...
              // Lazy-loaded: visited occasionally, heavy deps (Stripe, schedules, voice).
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/credentials/credentials-page").then(
                          (m) => m.CredentialsPage,
                        ),
                    },
                  },
                  ...
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/keyboard-shortcuts/keyboard-shortcuts-redirect-page").then(
                          (m) => m.KeyboardShortcutsRedirectPage,
                        ),
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/pages/devices-redirect-page").then(
                          (m) => m.DevicesRedirectPage,
                        ),
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/pages/security-redirect-page").then(
                          (m) => m.SecurityRedirectPage,
                        ),
                    },
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/pages/archive-redirect-page").then(
                          (m) => m.ArchiveRedirectPage,
                        ),
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/settings/pages/billing-redirect-page").then(
                          (m) => m.BillingRedirectPage,
                        ),
                    },
                  },
                  {
              ...
              // renders its own dark shell outside ChatLayout chrome.
              {
                ...
                lazy: {
                  Component: () =>
                    import("@/domains/settings/billing/plans/plans-page").then(
                      (m) => m.PlansPage,
                    ),
                },
              },
                ...
                children: [
                  {
                    ...
                    lazy: {
                      Component: () =>
                        import("@/domains/logs/pages/usage-redirect-page").then(
                          (m) => m.UsageRedirectPage,
                        ),
                    },
                  },
                  {
                      ...
                      },
                      {
                        ...
                        children: [
                          ...
                          },
                          {
                            ...
                            lazy: {
                              Component: () =>
                                import("@/domains/intelligence/personality-page").then(
                                  (m) => m.PersonalityPage,
                                ),
                            },
                          },
                          ...
                          // detail drawer.
                          {
                            ...
                            lazy: {
                              Component: () =>
                                import("@/domains/schedules/schedules-page").then(
                                  (m) => m.SchedulesPage,
                                ),
                            },
                          },
                          ...
                          // URLs redirect here; the per-item detail routes stay.
                          {
                            ...
                            lazy: {
                              Component: () =>
                                import("@/domains/intelligence/superpowers-page").then(
                                  (m) => m.SuperpowersPage,
                                ),
                            },
                          },
                          ...
                          },
                          {
                            ...
                            lazy: {
                              Component: () =>
                                import("@/domains/intelligence/skill-detail-page").then(
                                  (m) => m.SkillDetailPage,
                                ),
                            },
                          },
