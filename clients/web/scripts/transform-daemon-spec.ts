 ...
 * `/v1/debug` (exact) stays excluded; `/v1/debug/database`
...
const EXCLUDED_EXACT = new Set(["/v1/debug"]);
...
info.description =
  ...
  "Auto-generated — do not edit. Regenerate: cd clients/web && bun run scripts/transform-daemon-spec.ts";
