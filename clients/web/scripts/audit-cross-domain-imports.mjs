#!/usr/bin/env node
/**
 * Audit cross-domain imports under `clients/web/src/domains/` and
 ...
 * `clients/web/docs/CONVENTIONS.md` → "How to decide where the
 ...
 *   node clients/web/scripts/audit-cross-domain-imports.mjs --stats
 */
