...
| `slack-roster-link.ts` | `0.10.6-dev.202607071900.0000000` | Contact Slack row is Invite-only; provenance line shows the raw member ID | "Link account" roster picker via `GET /v1/slack/users`, plus @handle lookup for the provenance line |
