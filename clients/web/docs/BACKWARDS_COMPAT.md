...
| `use-supports-discord-channel.ts`            | `0.11.6`                          | No Discord readiness probe; asked about Discord the daemon answers with its unsupported snapshot, so the Channels page omits the row entirely                                                                                                                                                                                                      | The probe exists; Discord renders on the Channels page with readiness, a trust-floor control, and guided setup                                                                                                                                                                                                 |
