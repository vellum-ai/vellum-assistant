...
| `auto-profile-preview.ts`                    | `0.12.4-dev.202609232047.847daa9`           | No `POST /v1/auto-profile/preview`; on the Auto profile the composer pill reads plain "Auto" while typing                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | The route exists; after a typing pause the pill reads "Auto · <profile>" for the current draft, and the sending turn reuses that pick                                                                                                                                                                                                                                                                                                                                                 |
