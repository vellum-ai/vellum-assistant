...
| `guardian-notification-targeting.ts`         | `0.12.2-dev.202609181913.1108ac3`           | The assistant broadcasts a guardian-scoped `notification_intent` to every SSE connection, so the client drops any intent carrying `targetGuardianPrincipalId` and acks it without a banner                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | The assistant delivers guardian-scoped intents only to connections authenticated as the guardian, so the client shows them like any other notification                                                                                                                                                                                                                                                                                                                                |
