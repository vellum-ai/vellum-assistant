...
| `download.done`                    | `{ id?, filename, state }`                                                                    | Electron host only: the main process finished (or failed) saving a download this window started (`runtime/event-sources/electron-downloads.ts`), or `saveFile` could not fetch a URL source into a blob so no download could start (the shell denies the cross-origin anchor fallback, leaving that failure no other signal). `id` accompanies `state: "completed"` and keys the file-manager reveal. `use-download-feedback` consumes and shows the completion or failure toast.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
