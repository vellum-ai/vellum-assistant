...
export function TermsOfUseBody() {
  return (
    <DocsContent title="Vellum Terms of Service" breadcrumb="Docs / Legal / Terms">
                  <p>
                  ...
                  <h2>5. Vellum Intellectual Property</h2>
                  <p>
                  ...
                  <h2>6. Payment</h2>
                  <p>
                    <strong>6.1 Transactions.</strong> We may make available the ability to purchase certain products or functionalities through the Services (a &quot;Transaction&quot;) as further described <a href="/docs/pricing">here</a>. The purchase and use of Vellum Credits is a Transaction and is additionally governed by Section 6.2 of these Terms. If you wish to make a Transaction, you may be asked to supply certain relevant information, such as your credit card number and its expiration date, and your billing address, or connect to a digital wallet. YOU REPRESENT AND WARRANT THAT YOU HAVE THE RIGHT TO USE ANY CREDIT CARD THAT YOU SUBMIT IN CONNECTION WITH A TRANSACTION. By submitting such information, you grant us the right to provide such information to third parties for purposes of facilitating Transactions. Verification of information may be required prior to the acknowledgment or completion of any Transaction. By making a Transaction, you represent that the applicable purchases will be used only in a lawful manner. All Transactions are exclusive of applicable taxes. You are responsible for paying all taxes, duties, and other governmental assessments associated with your Transactions.
                  </p>

                  <p>
                    <strong>6.2 Vellum Credits.</strong>
                  </p>
                  <p>
                    <strong>(a) Overview.</strong> Vellum makes available certain features and functionalities within the Services, as designated by Vellum from time to time, that are accessible exclusively through the use of prepaid credits (&quot;Vellum Credits&quot;). These designated features and functionalities are referred to as &quot;Credit-Eligible Features.&quot;
                  </p>
                  <p>
                    <strong>(b) Credit-Eligible Features.</strong> Vellum may add or remove Credit-Eligible Features at any time in its sole discretion. Vellum Credits represent the right to access a variable quantity of Credit-Eligible Features. The amount of Credit-Eligible Features obtainable per Vellum Credit may vary based on factors including the type of feature, usage volume, underlying third-party costs, and other operational considerations.
                  </p>
                  <p>
                    <strong>(c) Denomination.</strong> Vellum Credits are denominated at a rate of one (1) Vellum Credit per one U.S. Dollar ($1.00 USD). Pricing for Credit-Eligible Features is determined by Vellum and may change at any time.
                  </p>
                  <p>
                    <strong>(d) Purchasing Credits.</strong> You may fund your Vellum Credit balance (&quot;Vellum Balance&quot;) by purchasing Vellum Credits in predefined increments.
                  </p>
                  <p>
                    <strong>(e) Balance Limit.</strong> You may not hold a Vellum Balance exceeding one thousand (1,000) Vellum Credits at any time. If a proposed purchase of Vellum Credits would cause your Vellum Balance to exceed this limit, the purchase will be declined.
                  </p>
                  <p>
                    <strong>(f) Deductions and Metering.</strong> Your Vellum Balance is automatically deducted when you opt into and use Credit-Eligible Features. Vellum Balance deductions are calculated by Vellum based on actual usage. Vellum reserves the right to adjust metering and pricing for Credit-Eligible Features at any time. Vellum will make reasonable efforts to display your current Vellum Balance and usage information through the Services.
                  </p>
                  <p>
                    <strong>(g) Promotional Credits.</strong> From time to time, Vellum may issue Vellum Credits at no charge in connection with account creation, mailing list enrollment, promotional campaigns, or other programs (&quot;Promotional Credits&quot;). Promotional Credits function identically to purchased Vellum Credits except as set forth in this Section 6.2(g). Promotional Credits may have a different expiration period, as specified at the time of issuance. Promotional Credits will not be applied against any sales, use, gross receipts, or similar transaction-based taxes that may apply to you. Unless otherwise specified, Promotional Credits will be consumed before Purchased Credits.
                  </p>
                  <p>
                    <strong>(h) Expiration.</strong> Purchased Vellum Credits expire twelve (12) months from the date of purchase. Promotional Credits expire on the date specified at the time of issuance. Expired Credits are forfeited and cannot be restored, extended, or refunded.
                  </p>
                  <p>
                    <strong>(i) Non-Transferability.</strong> Vellum Credits are non-transferable between users, accounts, or Organizations. Vellum Credits may not be sold, bartered, exchanged, or otherwise transferred to any third party. Any attempted transfer, sale, or exchange in violation of this Section is void and may result in the revocation of the Vellum Credits and suspension or termination of your account.
                  </p>
                  <p>
                    <strong>(j) No Cash Value.</strong> Vellum Credits have no cash value, are not a stored-value instrument, deposit account, or any form of currency, and may not be redeemed for cash or any consideration other than Credit-Eligible Features.
                  </p>
                  <p>
                    <strong>(k) No Refunds.</strong> Vellum Credits are non-refundable, except where required by applicable law.
                  </p>
                  <p>
                    <strong>(l) Effect of Suspension or Termination.</strong> Upon suspension or termination of your account or this Agreement for any reason, any remaining Vellum Credits in your Vellum Balance, whether purchased or promotional, are immediately forfeited and will not be refunded, except where required by applicable law.
                  </p>

                  <h2>7. Term and Termination</h2>
                  <p>
                    <strong>7.1 Term.</strong> This Agreement is effective until terminated. Company may terminate or suspend your use of the Site at any time and without prior notice, for any or no reason, including if Company believes that you have violated or acted inconsistently with the letter or spirit of this Agreement.
                  </p>
                  <p>
                    <strong>7.2 Effect of Termination.</strong> Upon termination of the Agreement, (a) all rights, licenses, consents, and authorizations granted by either party to the other hereunder will immediately terminate; (b) Company may, without liability to you or any third party, immediately deactivate or delete your user name, password and account, and all associated materials, without any obligation to provide any further access to such materials; (c) you will pay all fees incurred prior to such termination; and (d) You will immediately cease all use of any Services. Sections 1.3 (Suspension); 3.1 (Compliant Use); 3.2 (Export Controls); 2.1 (Input); 2.2 (Results and Output); 5 (Vellum Intellectual Property); 6 (Payment); 7.2 (Effect of Termination); 8 (Disclaimer); 9 (Indemnification); 10 (Limitation of Liability); 11 (Arbitration); 12 (Governing Law); and 13 (Miscellaneous) will survive any expiration or termination of the Agreement.
                  </p>
                  ...
                  <p>
                    <strong>11.1 Claims Subject to this Section.</strong> The dispute resolution and binding arbitration terms in this Section 11 apply to all Claims between you and Vellum. A &quot;Claim&quot; is any dispute, claim, or controversy (excluding those exceptions listed below) between you and Vellum, whether based in contract, tort, statute, fraud, misrepresentation, or any other legal theory, that either party wishes to seek legal recourse for and that arises from or relates to this Agreement or our Services, including any privacy or data security claims or claims related to the validity, enforceability, or scope of the arbitration requirement or any portion of it.
                  </p>
                  <p>
                    <strong>11.2 Informal Dispute Resolution Prior to Arbitration.</strong> If you have a Claim against Vellum or if Vellum has a Claim against you, you and Vellum will first attempt to resolve the Claim informally in order to try and resolve the Claim faster and reduce costs for both parties. You and Vellum will make a good-faith effort to negotiate the resolution of any Claim for 30 days, or such longer period as mutually agreed in writing (email suffices) by the parties, (&quot;Informal Resolution Period&quot;) from the day either party receives a written notice of a dispute from the other party (a &quot;Claimant Notice&quot;) in accordance with this Agreement.
                  </p>
                  <p>
                    You will send any Claimant Notice to Vellum by email to <a href="mailto:support@vellum.ai">support@vellum.ai</a>. Vellum will send any Claimant Notice to you by certified mail or email using the contact information you have provided to Vellum. The Claimant Notice sent by either party must (i) include the sender&apos;s name, address, email address, and telephone number; (ii) describe the nature and basis of the Claim; and (iii) set forth the specific relief sought.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>11.5 Arbitration Procedure and Location.</strong> You or Vellum may initiate arbitration of any Claim not resolved during the Informal Resolution Period by filing a demand for arbitration with NAM in accordance with the Rules (or with AAA in accordance with the Rules if applicable pursuant to Section 11.4).
                  </p>
                  <p>
                    Instructions for filing a demand for arbitration with NAM are available on the NAM website or by calling NAM at 800-358-2550, and instructions for filing a demand for arbitration with AAA are available on the AAA website or by calling AAA at 800-778-7879. You will send a copy of any demand for arbitration to Vellum by email to <a href="mailto:support@vellum.ai">support@vellum.ai</a>. Vellum will send any demand for arbitration to you by certified mail or email using the contact information you have provided to Vellum.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>11.6 Arbitration Fees.</strong> Each party will be responsible for arbitration fees in accordance with the applicable Rules and this Agreement.
                  </p>
                  <p>
                    <strong>11.7 Frivolous or Improper Claims.</strong> To the extent permitted by applicable law, a claimant must pay all costs incurred by the defending party, including any attorney&apos;s fees, related to a Claim if an arbitrator determines that (i) the Claim was not warranted by existing law or by a nonfrivolous argument or (ii) the Claim was filed in arbitration for any improper purpose, such as to harass the defending party, cause unnecessary delay, or needlessly increase the cost of dispute resolution.
                  </p>
                  <p>
                    <strong>11.8 Offers of Settlement.</strong> Either party may, but is not obligated to, make a written settlement offer for a Claim. If an arbitration decision or award is later issued that is less favorable to a party than the latest written offer of settlement that party did not accept, that party must pay all costs and fees — including arbitration, attorney, and expert fees — incurred by the other party after the written settlement offer was made. The terms of any settlement offer may not be disclosed to an arbitrator until after the arbitrator issues a decision or award on the Claim.
                  </p>
                  <p>
                    <strong>11.9 One Year to Assert Claims.</strong> To the extent permitted by law, any Claim by you or Vellum against the other must be filed within one year after such Claim arises; otherwise, the Claim is permanently barred, which means that you or Vellum will no longer have the right to assert that Claim.
                  </p>
                  <p>
                    <strong>11.10 Confidentiality.</strong> If you or Vellum submits a Claim to arbitration, you and Vellum agree to cooperate to seek from the arbitrator protection for any confidential, proprietary, trade secret, or otherwise sensitive information, documents, testimony, and other materials that might be exchanged or the subject of discovery in the arbitration. You and Vellum agree to seek such protection before any such information, documents, testimony, or materials are exchanged or otherwise become the subject of discovery in the arbitration.
                  </p>
                  <p>
                    <strong>11.11 Coordinated Filings.</strong> If 25 or more Claimant Notices are received by a party that raise similar claims and have the same or coordinated counsel, these will be considered &quot;Coordinated Claims&quot; and will be treated as mass filings or multiple case filings according to the Rules, if and to the extent Coordinated Claims are filed in arbitration as set forth in this Agreement. You or Vellum may advise the other of your or its belief that Claims are Coordinated Claims, and disputes over whether a Claim meets the definition of &quot;Coordinated Claims&quot; will be decided by the arbitration provider as an administrative matter.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>11.12 Opting Out of Arbitration.</strong> You have the right to opt out of binding arbitration within 30 days of the date you first accepted this Agreement by providing us with notice of your decision to opt-out via email at <a href="mailto:support@vellum.ai">support@vellum.ai</a>. To be effective, the opt-out notice must include your full name, mailing address, and email address. The notice must also clearly indicate your intent to opt out of binding arbitration. By opting out of binding arbitration, you are agreeing to resolve disputes in accordance with Section 12.
                  </p>
                  <p>
                    <strong>11.13 Rejection of Future Arbitration Changes.</strong> You may reject any change we make to Section 11 (except address changes) by sending us notice of your rejection within 30 days of the change via email at <a href="mailto:support@vellum.ai">support@vellum.ai</a>. Changes to Section 11 may only be rejected as a whole, and you may not reject only certain changes to Section 11. If you reject changes made to Section 11, the most recent version of Section 11 that you have not rejected will continue to apply.
                  </p>
                  <p>
                    <strong>11.14 Severability.</strong> If any portion of this Section 11 is found to be unenforceable or unlawful for any reason, including but not limited to because it is found to be unconscionable, (i) the unenforceable or unlawful provision will be severed from this Agreement; (ii) severance of the unenforceable or unlawful provision will have no impact whatsoever on the remainder of this Section 11 or the parties&apos; ability to compel arbitration of any remaining claims on an individual basis pursuant to this Section 11; and (iii) to the extent that any claims must therefore proceed on a class, collective, consolidated, or representative basis, such claims must be litigated in a civil court of competent jurisdiction and not in arbitration. The litigation of those claims will be stayed pending the outcome of any individual claims in arbitration. Further, if any part of this Section 11 is found to prohibit an individual claim seeking public injunctive relief, that provision will have no effect to the extent such relief is allowed to be sought out of arbitration, and the remainder of this Section 11 will be enforceable.
                  </p>
                  <p>
                  ...
                  <h2>13. Copyright Infringement Claims</h2>
                  <p>
                    The Digital Millennium Copyright Act of 1998 (the &quot;DMCA&quot;) provides recourse for copyright owners who believe that material appearing on the Internet infringes their rights under U.S. copyright law. If you believe in good faith that materials available on the Services infringe your copyright, you (or your agent) may send to Vellum a written notice by mail or e-mail, requesting that Vellum remove such material or block access to it. If you believe in good faith that someone has wrongly filed a notice of copyright infringement against you, the DMCA permits you to send Vellum a counter-notice. Notices and counter-notices must meet the then-current statutory requirements imposed by the DMCA. See <a href="http://www.copyright.gov/" target="_blank" rel="noreferrer">http://www.copyright.gov/</a> for details. Notices and counter-notices must be sent in writing to Vellum&apos;s DMCA Agent as follows: E-mail to <a href="mailto:support@vellum.ai">support@vellum.ai</a>.
                  </p>

                  <h2>14. Miscellaneous</h2>
                  <p>
                    <strong>14.1 Publicity.</strong> You agree to allow Vellum to use and display your name and logo on Vellum&apos;s website and in Vellum&apos;s promotional materials to identify you as a customer.
                  </p>
                  <p>
                    <strong>14.2 Feedback.</strong> Vellum may use and exploit, without any payment or attribution obligation of any kind, any comments, feedback, suggestions, or ideas (&quot;Feedback&quot;) that you provide to Vellum in connection with the Agreement or the Services. You waive any moral and similar rights relating to Feedback that you may have under any applicable law.
                  </p>
                  <p>
                    <strong>14.3 Severability.</strong> If any provision of the Agreement is found to be unenforceable or invalid, that provision will be limited or eliminated to the minimum extent necessary so that the Agreement will otherwise remain in full force and effect and enforceable.
                  </p>
                  <p>
                    <strong>14.4 Assignment.</strong> The Agreement is not assignable, transferable, or sublicensable by you except with Vellum&apos;s prior written consent. Vellum may freely assign this Agreement. The Agreement is binding upon, and inures to the benefit of, the party&apos;s respective permitted successors and assigns.
                  </p>
                  <p>
                    <strong>14.5 Entire Agreement.</strong> The Agreement is the complete and exclusive statement of the mutual understanding of the parties and supersedes and cancels all previous written and oral agreements, communications and other understandings relating to the subject matter of the Agreement. The Agreement will be deemed to be the product of both parties, and no ambiguity will be construed in favor of or against either party.
                  </p>
                  <p>
                    <strong>14.6 Interpretation.</strong> The terms &quot;e.g.,&quot; &quot;such as,&quot; &quot;include,&quot; &quot;includes,&quot; and &quot;including&quot; are not limiting and are deemed to be followed by the words &quot;without limitation.&quot; The terms &quot;herein,&quot; &quot;hereto,&quot; &quot;hereunder&quot; and terms of similar import refer to the Agreement in its entirety and not to any particular provision of the Agreement. Except where the context otherwise requires, wherever used, the word &quot;or&quot; is used in the inclusive sense. URLs are understood to also refer to successor URLs, URLs for localized content, and information or resources linked from within the websites at the specified URLs. Titles and headings of sections of this Agreement are for convenience only and shall not affect the construction of any provision of this Agreement.
                  </p>
                  <p>
                    <strong>14.7 No Waiver.</strong> All waivers and modifications must be in a writing signed by both parties, except as otherwise provided herein.
                  </p>
                  <p>
                    <strong>14.8 No Agency.</strong> No agency, partnership, joint venture, or employment is created as a result of the Agreement and neither party has any authority of any kind to bind the other party in any respect whatsoever.
                  </p>
                  <p>
                    <strong>14.9 Prevailing Party.</strong> In any action or proceeding to enforce rights under the Agreement, the prevailing party will be entitled to recover substantiated costs and attorneys&apos; fees from the non-prevailing party.
                  </p>
                  <p>
                    <strong>14.10 Information or Complaints.</strong> If you have a question or complaint regarding the Site, please send an e-mail to <a href="mailto:support@vellum.ai">support@vellum.ai</a>. You may also contact us by writing or by calling us. Please note that e-mail communications will not necessarily be secure; accordingly you should not include credit card information or other sensitive information in your e-mail correspondence with us. California residents may reach the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs by mail at 1625 North Market Blvd., Sacramento, CA 95834, or by telephone at (916) 445-1254 or (800) 952-5210.
                  </p>
                  ...
                  <p>
                    <strong>iOS.</strong> The following terms apply if you install, access, or use the Services on any device that contains the iOS mobile operating system (the &quot;iOS App&quot;) developed by Apple Inc. (&quot;Apple&quot;):
                  </p>
                  <ul>
                    <li><strong>Acknowledgement.</strong> You acknowledge that these Terms are concluded solely between us, and not with Apple. Vellum, not Apple, is solely responsible for this iOS App and the content thereof. You further acknowledge that the usage rules for the iOS App are subject to any additional restrictions set forth in the Usage Rules for the Apple iOS App Store Terms of Service as of the date you download the App, and in the event of any conflict, the Usage Rules in the Apple iOS App Store will govern if they are more restrictive. You acknowledge that you have had the opportunity to review the Usage Rules.</li>
                    <li><strong>Scope of License.</strong> The license granted to you is limited to a non-transferable license to use the iOS App on any iPhone, iPod touch, iPad, or any other Apple device that you own or control as permitted by the Usage Rules set forth in the Apple iOS App Store Terms of Service.</li>
                    <li><strong>Maintenance and Support.</strong> You and Vellum acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the App.</li>
                    <li><strong>Warranty.</strong> You acknowledge that Apple is not responsible for any product warranties, whether express or implied by law, with respect to the App. In the event of any failure of the iOS App to conform to any applicable warranty, you may notify Apple, and Apple will refund the purchase price, if any, paid to Apple for the iOS App by you; and to the maximum extent permitted by applicable law, Apple will have no other warranty obligation whatsoever with respect to the App. The parties acknowledge that to the extent that there are any applicable warranties, any other claims, losses, liabilities, damages, costs, or expenses attributable to any failure to conform to any such applicable warranty would be the sole responsibility of Vellum. However, Vellum has disclaimed all warranties of any kind with respect to the App, and therefore, there are no warranties applicable to the App.</li>
                    <li><strong>Product Claims.</strong> You and Vellum acknowledge that as between Apple and Vellum, Vellum, not Apple, is responsible for addressing any claims relating to the iOS App or your possession and/or use of the iOS App, including, but not limited to (a) product liability claims, (b) any claim that the iOS App fails to conform to any applicable legal or regulatory requirement, and (c) claims arising under consumer protection or similar legislation.</li>
                    <li><strong>Intellectual Property Rights.</strong> The parties acknowledge that, in the event of any third-party claim that the iOS App or your possession and use of the iOS App infringe that third party&apos;s intellectual property rights, Vellum, and not Apple, will be solely responsible for the investigation, defense, settlement and discharge of any such intellectual property infringement claim to the extent required under these Terms.</li>
                    <li><strong>Developer Name and Address.</strong> Any questions, complaints, or claims with respect to the iOS App should be directed to: Vellum AI, 169 Madison Avenue, New York NY, 10016 — <a href="mailto:support@vellum.ai">support@vellum.ai</a></li>
                    <li><strong>Third-Party Terms of Agreement.</strong> You will comply with any applicable third-party terms when using the Services.</li>
                    <li><strong>Third-Party Beneficiary.</strong> Apple and its subsidiaries are third-party beneficiaries of these Terms, and upon your acceptance of these Terms, Apple will have the right (and will be deemed to have accepted the right) to enforce these Terms against you as a third-party beneficiary thereof.</li>
                  </ul>
                  <p>
                    <strong>Android.</strong> The following terms apply if you install, access, or use the Services on any device that contains the Android mobile operating system (the &quot;Android App&quot;) developed by Google, Inc. (&quot;Google&quot;):
                  </p>
                  <ul>
                    <li>You acknowledge that these Terms are between you and us only, and not with Google.</li>
                    <li>Your use of our Android App must comply with Google&apos;s then-current Android Market Terms of Service.</li>
                    <li>Google is only a provider of the Android Market where you obtained the Android App. We, and not Google, are solely responsible for our Android App and the Services and content available thereon. Google has no obligation or liability to you with respect to our Android App or these Terms.</li>
                    <li>Google is a third-party beneficiary to the Terms as they relate to our Android App.</li>
                  </ul>
    </DocsContent>
  );
}
