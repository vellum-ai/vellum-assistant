...
const TOC_ITEMS = [
  ...
  { id: "desktop-app", label: "Desktop app (macOS)", level: 2 },
  { id: "windows-and-linux", label: "Windows and Linux", level: 2 },
    ...
    <>
      <DocsContent title="Installation" breadcrumb="Docs / Getting Started / Installation">
        <section id="what-you-need">
          ...
          <ul className="mb-4 list-disc space-y-2 pl-6 text-zinc-600">
            ...
            <li>
              ...
              There is no shipped Windows or Linux desktop client.
            </li>
            <li>
        ...
        <section id="desktop-app" className="mt-12">
          ...
          <p className="mb-4 text-zinc-600">
            The shipped desktop app is macOS only. It gives you a menu bar presence, voice
            input with hold-to-talk, and the ability to control your Mac through
            accessibility APIs. It connects to a cloud assistant by default (so your
            conversations and memory show up in both the web and desktop apps), but it can
            also run a local assistant entirely on your machine. See{" "}
          ...
          <ol className="mb-4 list-decimal space-y-2 pl-6 text-zinc-600">
            ...
            <li>
              Download the macOS <code>.dmg</code> from{" "}
              <a href={routes.downloads} className="font-semibold text-emerald-700 underline hover:text-emerald-800">
                vellum.ai/downloads
              </a>
              .
          ...
          <p className="mb-6 text-zinc-600">
            ...
            files. Standard <code>.dmg</code>, signed and notarized. The same page also
            offers the{" "}
        ...
        <section id="windows-and-linux" className="mt-12">
          <SectionHeading id="windows-and-linux" level={2}>
            Windows and Linux
          </SectionHeading>
          <p className="mb-4 text-zinc-600">
            There is no shipped Windows or Linux desktop client. A Windows Electron app
            exists in development, but it is not on the public download page. A Linux
            desktop shell is also in development and is not distributed.
          </p>
          <p className="mb-4 text-zinc-600">
            On a Windows or Linux computer you can:
          </p>
          <ul className="mb-4 list-disc space-y-2 pl-6 text-zinc-600">
            <li>
            ...
            <li>
              On Linux, self-host the assistant runtime on that machine. That is the
              server, not a desktop app. See{" "}
              <a href="/docs/hosting-options" className="font-semibold text-emerald-700 underline hover:text-emerald-800">
                Hosting options
              </a>
              .
          ...
          <p className="mb-6 text-zinc-600">
            ...
            Linux runtime as a replacement for the Mac desktop app&apos;s computer-use
            features.
          </p>
        </section>
