      ...
      <DocsContent title="FAQ" breadcrumb="Docs / Help / FAQ">
        <section id="about-the-product">
          ...
          <p className="mb-6 text-zinc-600">
            ...
            , the iPhone and iPad app, the Android app, the macOS desktop app, and a
            command-line interface. There is no shipped Windows or Linux desktop client.
            On Windows or Linux, use the web app or the Chrome extension. The assistant
            runtime can self-host on a Linux machine; that is hosting, not a desktop app.
          ...
          <p className="mb-6 text-zinc-600">
            Not a shipped desktop app. On a Windows PC, open{" "}
            <Link
              href="https://vellum.ai"
              className="font-semibold text-emerald-700 underline hover:text-emerald-800"
            >
            ...
            so the assistant can use your Chrome session. A native Windows client exists
            in development and is not on the public{" "}
            <Link
              href={routes.downloads}
              className="font-semibold text-emerald-700 underline hover:text-emerald-800"
            >
