        ...
        <section id="tips-gotchas" className="mt-12">
          ...
          <ul className="mb-0 list-disc space-y-2 pl-6 text-zinc-600">
            ...
            <li>
              ...
              contact&rdquo; gives them limited access to your assistant &mdash;
              they can chat but can&apos;t access your memories or sensitive
              tools without guardian approval.
            </li>
            <li>
