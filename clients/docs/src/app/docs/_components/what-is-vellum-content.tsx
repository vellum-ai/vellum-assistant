...
const TOC_ITEMS = [
  { id: "short-version", label: "The short version", level: 2 },
  {
    ...
    label: "How is this different from ChatGPT, Claude, OpenClaw, or Hermes?",
    level: 2,
  },
    ...
    <>
      <DocsContent title="What is Vellum?" breadcrumb="Docs / Getting Started / What is Vellum?">
        ...
        <section id="how-is-this-different-from-chatgpt-claude-etc" className="mt-12">
          ...
          <p className="mb-6 text-zinc-600">
            Tools like OpenClaw and Hermes Agent take a more DIY approach. They
            run in your terminal, expect you to configure them yourself, and
            assume you&apos;re comfortable wiring up API keys, model providers, and
            tool integrations before you can get anything done.
          </p>
          <p className="mb-3 text-zinc-600">
            <strong>It works out of the box.</strong> No config files to write, no
            CLI to install, no model routing to set up. Sign up and your assistant
            is running, connected to cloud AI models, and ready to go. OpenClaw and
            Hermes expect you to bring your own keys, pick your own providers, and
          ...
          <p className="mb-3 text-zinc-600">
            ...
            there too, but most people want a screen they can click.
          </p>
          <p className="mb-3 text-zinc-600">
            <strong>It&apos;s built for security and reliability.</strong>{" "}
            Credentials are encrypted at rest. Sensitive actions require explicit
            approval. Your workspace is isolated to your account with no shared
            state. Vellum Cloud runs on managed infrastructure with monitoring and
            uptime you don&apos;t have to maintain. Self-hosting is there if you want
            full control, but you don&apos;t have to trade reliability for
            ownership.
          </p>
          <p className="mb-0 text-zinc-600">
            OpenClaw and Hermes are powerful if you&apos;re technical and want to
            build everything yourself. Vellum is for people who want the power
        ...
        <section id="where-does-it-run" className="mt-12">
          ...
          <div className="mb-6">
            <h3 className="mb-2 text-base font-semibold text-zinc-800">📱 iOS app</h3>
            <p className="mb-2 text-zinc-600">
              Install Vellum Assistant on your iPhone or iPad and sign in to the
              same assistant you use on the web and Mac. Your conversations,
              memories, tools, and workspace stay with you across devices.
            </p>
            <ul className="list-disc space-y-1 pl-6 text-zinc-600">
              <li>Available from the App Store</li>
              <li>Talk to your assistant from your iPhone or iPad</li>
              <li>Review approval requests from mobile notifications</li>
            </ul>
          </div>
          <div className="mb-0">
