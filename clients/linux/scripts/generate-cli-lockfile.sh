...
# cli-installer.ts is shared by the desktop clients (see packages/desktop-shell).
CLI_INSTALLER="$APP_DIR/../../packages/desktop-shell/src/main/cli-installer.ts"
VERSION=$(grep -o 'PINNED_CLI_VERSION = "[^"]*"' "$CLI_INSTALLER" \
