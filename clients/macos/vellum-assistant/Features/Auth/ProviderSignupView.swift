...
#if DEBUG
struct ProviderSignupView_Preview: PreviewProvider {
    static var previews: some View {
        ProviderSignupPreviewWrapper()
            .frame(width: 500, height: 500)
            .previewDisplayName("ProviderSignupView")
    }
}

private struct ProviderSignupPreviewWrapper: View {
    var body: some View {
        ZStack {
