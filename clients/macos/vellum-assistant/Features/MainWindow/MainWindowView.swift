...
// Grouped state types (SharingState, SidebarInteractionState, CopyThreadState)
// moved to MainWindowGroupedState.swift
...
struct MainWindowView: View {
    ...
    @State var threadSwitcherHoverTimer: DispatchWorkItem?
    /// Work item that dismisses the thread switcher popover after leaving the hover area.
    @State var threadSwitcherDismissTimer: DispatchWorkItem?
    ...
    // threadItem — moved to Sidebar/SidebarThreadItem.swift (standalone view)

    // Sidebar content (selectThread, interactionDotColor, regularThreads,
    // scheduleThreads, displayedThreads, displayedScheduleThreads,
    // scheduleThreadGroups, displayedScheduleGroups, displayedApps,
    // sidebarView, sidebarPinnedAppRow, expandedSidebarContent,
    // collapsedSidebarContent, isAppSurfaceActive, openAppInWorkspace)
    // moved to MainWindowView+Sidebar.swift

}

// ZoomIndicatorView — moved to Sidebar/ZoomIndicatorView.swift

// SidebarPrimaryRow + SidebarNavRow alias — moved to Sidebar/SidebarPrimaryRow.swift

// SidebarThreadsHeader — moved to Sidebar/SidebarThreadsHeader.swift

// PreferencesRow — moved to Sidebar/PreferencesRow.swift

// DrawerMenuView — moved to Sidebar/DrawerMenuView.swift

// DrawerThemeToggle — moved to Sidebar/DrawerThemeToggle.swift

// ScheduleReorderDropDelegate + ScheduleGroupHeaderDropDelegate
// moved to Sidebar/ScheduleDropDelegates.swift

// DrawerMenuItem — moved to Sidebar/DrawerMenuItem.swift
