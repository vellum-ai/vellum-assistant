 ...
 * other. The underlying process is the same signed binary. Screen Recording
 * is checked through a fresh launch of this executable and against the app's
 * own permission entry (see
