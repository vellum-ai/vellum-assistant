...
| Tauri HUD and client observability | in_progress | Surface meaningful real-time assistant state (action lifecycle, perception, voice cadence) | Validate HUD rendering and event subscriptions against current assistant contracts | [`docs/jarvis-roadmap.md`](../jarvis-roadmap.md) | none |
