...
export async function routedPostTweet(
  ...
  if (strategy === 'oauth') {
    ...
    if (!oauthIsAvailable()) {
      throw Object.assign(new Error('OAuth is not configured. Provide your X developer credentials here in the chat to set up OAuth, or switch to browser strategy: `twitter strategy set browser`.'), {
