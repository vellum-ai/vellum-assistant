...
## Viewing Available w/ OAuth Applications

Vellum assistants can natively integrate with any application that supports OAuth 2.0. Many OAuth providers come pre-configred and ready to use. You can view them by running:
...
- Vellum does not have a first-party integration with the provider and maanged mode is not support
