...
description: Answer questions about Vellum, the assistant's architecture, capabilities, current configuration, installation, and hosting options by routing to live sources of truth
