...
parser.add_argument("--permissions", default="contents:write,pull_requests:write,actions:write,workflows:write,checks:read,metadata:read",
                    help="Comma-separated permission:level pairs (default: contents:write,pull_requests:write,actions:write,workflows:write,checks:read,metadata:read)")
