...
name: plugin-builder
description: >-
  Use when the user wants to build, scaffold, ship, or edit a Vellum plugin
  that bundles hooks, tools, and skills into one installable package.
...
Once merged, users install by name: `assistant plugins install my-plugin`. Restart the assistant to pick up the new code.
