...
| [Channels](references/channels.md)         | `channels/ingress.json` | Declare public webhook and WebSocket routes that make the plugin a channel. The gateway verifies them and forwards to matching routes.           |
