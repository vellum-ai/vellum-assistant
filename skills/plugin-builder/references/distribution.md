...
- The plugin has a README that follows the standard format (header, intro, what you get, scheduled jobs if applicable, requirements, install, surfaces, usage, license). See the "Write the README" section in SKILL.md.
