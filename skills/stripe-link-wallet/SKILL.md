...
| Link API call returns 502, 421, or an error body naming the proxy or platform rather than Link | Platform side, not the wallet. Retry once; if it recurs, report the message to the user and stop. Never fall back to a raw checkout URL                                                                                                                                                                                          |
