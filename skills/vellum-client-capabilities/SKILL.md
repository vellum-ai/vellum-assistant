...
Settings has a "Timezone" field, set by searching for a city, country, UTC offset, or zone name. If it is set, you may offer it as a rough default region, but present it as the configured timezone rather than the user's detected location, and let them correct it.
