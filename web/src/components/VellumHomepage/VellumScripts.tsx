...
export function VellumScripts() {
  ...
  return (
    <>
      ...
      {/* Tab Rotation */}
      <Script
        src="https://cdn.jsdelivr.net/npm/@flowbase-co/boosters-tab-rotation-webflow@1.2.2/dist/tab-rotation.js"
        integrity="sha384-NfwimfVJo0ivYDT5XCEV0qOVEOg5WAi1gRKNLKf9B1yMkwajX9dVU7Hjb+V0UFNr"
      ...
      {/* Finsweet Components */}
      <Script
        src="https://cdn.prod.website-files.com/63f416b32254e8eca5d8af54%2F6544eda5f000985a163a8687%2F6930a6d6157863a1f196065f%2Ffinsweetcomponentsconfig-1.0.3.js"
        type="module"
        strategy="lazyOnload"
      />
    </>
