...
const MOBILE_CLOSE_ICON = (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="CurrentColor" display="block" xmlns="http://www.w3.org/2000/svg">
    <path d="M21 1L1 21M1 1L21 21" stroke="white" strokeOpacity="0.6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const PRODUCT_ICON_0 = (
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="dropdown_link_icon">
    <path d="M3 6.5C3 5.6875 3.65625 5 4.5 5H7.5C8.3125 5 9 5.6875 9 6.5V9.5C9 10.3438 8.3125 11 7.5 11H4.5C3.65625 11 3 10.3438 3 9.5V6.5ZM10 14.5C10 13.6875 10.6562 13 11.5 13H14.5C15.3125 13 16 13.6875 16 14.5V17.5C16 18.3438 15.3125 19 14.5 19H11.5C10.6562 19 10 18.3438 10 17.5V14.5ZM16.5 5H19.5C20.3125 5 21 5.6875 21 6.5V9.5C21 10.3438 20.3125 11 19.5 11H16.5C15.6562 11 15 10.3438 15 9.5V6.5C15 5.6875 15.6562 5 16.5 5Z" fill="currentColor" />
    <path opacity="0.4" d="M7.5 11C8.25 11 8.90625 10.4375 8.96875 9.65625L11.5 13C10.7188 13 10.0625 13.5938 10 14.3438L7.5 11ZM9 7H15V9H9V7Z" fill="currentColor" />
  </svg>
);

const PRODUCT_ICON_1 = (
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 24" fill="none" className="dropdown_link_icon">
...
const PRODUCT_ITEMS: NavDropdownItem[] = [
  { label: "Orchestration", href: "/products/orchestration", icon: PRODUCT_ICON_0 },
  { label: "SDK", href: "/products/workflows-sdk", icon: PRODUCT_ICON_1 },
  { label: "Evaluations", href: "/products/evaluation", icon: PRODUCT_ICON_2 },
  { label: "Retrieval", href: "/products/retrieval", icon: PRODUCT_ICON_3 },
  { label: "Deployment", href: "/products/deployments", icon: PRODUCT_ICON_4 },
  { label: "Observability", href: "/products/monitoring", icon: PRODUCT_ICON_5 },
];

const SOLUTION_ITEMS: NavDropdownItem[] = [
  { label: "Healthcare", href: "https://www.vellum.ai/industries/healthcare", icon: SOLUTION_ICON_0 },
  { label: "Retail", href: "https://www.vellum.ai/industries/consumer-retail", icon: SOLUTION_ICON_1 },
  { label: "Supply chain", href: "https://www.vellum.ai/industries/supply-chain", icon: SOLUTION_ICON_2 },
  { label: "Insurance", href: "https://www.vellum.ai/industries/insurance", icon: SOLUTION_ICON_3 },
  { label: "Government", href: "https://www.vellum.ai/industries/government", icon: SOLUTION_ICON_4 },
];

const RESOURCE_ITEMS: NavDropdownItem[] = [
  { label: "News", href: "/news", icon: RESOURCE_ICON_0 },
  { label: "Blog", href: "/blog", icon: RESOURCE_ICON_1 },
  { label: "Leaderboards", href: "/llm-leaderboard", icon: RESOURCE_ICON_2 },
  { label: "Webinars", href: "/webinars", icon: RESOURCE_ICON_3 },
  { label: "GPT-5 Playbook", href: "/gpt-5-benchmarks-and-prompting-tips", icon: RESOURCE_ICON_4, target: "_blank" },
];

const SPOTLIGHT_ITEMS: NavDropdownItem[] = [
  { label: "Case Studies", href: "/blog?category=Customer+Stories", icon: SPOTLIGHT_ICON_0 },
  { label: "Use Cases", href: "/use-case-directory", icon: SPOTLIGHT_ICON_1 },
];

function DropdownLink({ item }: { item: NavDropdownItem }) {
  return (
    <a aria-label={`Go to ${item.label} page`} href={item.href} target={item.target} className="dropdown_link u-hflex-left-center dark-mode w-inline-block">
      {item.icon}
      <div className="dropdown_link_text">{item.label}</div>
...
function NavDropdown({ label, items }: { label: string; items: NavDropdownItem[] }) {
  return (
    <li className="nav_list_item new hide-tablet">
      <div data-delay="200" data-hover="true" aria-label={`Hover on ${label} dropdown`} className="nav_list_dropdown nav_new-link w-dropdown">
  ...
  return (
    <div data-collapse="medium" data-animation="default" data-duration="400" fs-scrolldisable-element="smart-nav" data-easing="ease" data-easing2="ease" role="banner" className="navbar_component new w-nav">
      <div className="navbar2_container">
        ...
        <nav role="navigation" id="w-node-_45f8248c-ee2e-e6a9-2792-1d703651d359-3651d355" className="navbar2_menu is-page-height-tablet w-nav-menu">
          <ul fs-scrolldisable-element="preserve" role="list" className="nav_list u-hflex-between-center list-new new w-list-unstyled">
            ...
            <li className="nav_list_item new hide">
              <div data-delay="200" data-hover="true" aria-label="Hover on Resources dropdown" className="nav_list_dropdown nav_new-link w-dropdown">
                <div className="dropdown_toggle u-hflex-center-center new-link new w-dropdown-toggle">
                  <div>Resources</div>
                ...
                <nav className="dropdown_list is--resources dark-mode w-dropdown-list">
                  <div className="dropdown_list_inner _2col dark-mode">
                    <div className="dropdown-column-wrap dark-mode">
                      <div className="dropdown_link_text text-color-purple nav_tag drak-mode">Resources</div>
                      {RESOURCE_ITEMS.map((item) => (
                        <DropdownLink key={item.label} item={item} />
                      ))}
                    </div>
                    <div id="w-node-_45f8248c-ee2e-e6a9-2792-1d703651d3e9-3651d355" className="dropdown-column-wrap dark-mode alt">
                      <div className="dropdown_head-wrap">
                        <div className="dropdown_link_text text-color-purple nav_tag drak-mode">Customer Spotlights</div>
            ...
            <li className="nav_list_item mobile-vertical is-mobile">
              <a aria-label="Go to Community" href="/community" aria-current="page" className="nav_list_link newlink mobile_stroke main w--current">Community</a>
              <a aria-label="Go to Templates" href="/templates" className="nav_list_link newlink mobile_stroke main">Use Cases</a>
              <a aria-label="Go to Blog" href="/blog" target="_blank" className="nav_list_link newlink mobile_stroke main">Blog</a>
              <a aria-label="Go to Careers" href="https://jobs.ashbyhq.com/vellum" target="_blank" className="nav_list_link newlink mobile_stroke main">Careers</a>
            </li>
            <li className="nav_list_item hide-mobile-nav"></li>
          </ul>
          <div id="mobileclose" className="mobile_close">
            <div className="w-embed">{MOBILE_CLOSE_ICON}</div>
          </div>
        </nav>
        ...
        <div id="w-node-_45f8248c-ee2e-e6a9-2792-1d703651d480-3651d355" className="navbar2_button-wrapper hide-tablet new">
          <Link href="/login" className="text-block-130">Log in<br /></Link>
          <Link href="/signup" className="d-button nav-button-5 js-utm-signup cta-get-started new w-inline-block">
