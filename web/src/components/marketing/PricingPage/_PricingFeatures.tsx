...
export function PricingFeatures() {
  return (
    <div className="u-vflex-stretch-top hide-mobile">
      <div className="pricing_line is--header is-main">
        <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efb90-9296596a" className="u-hflex-left-center gap-icon">
          <div className="u-text-medium fw-medium">
Features
          </div>
        </div>
...
Enterprise
      ...
      <div>
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efba4-9296596a" className="u-hflex-left-center gap-icon">
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efbae-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
...
Unlimited credits
        ...
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efbc2-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Hosted agent apps
            </div>
...
∞
        ...
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efbcc-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Knowledge base
            </div>
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efbd4-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Parallel agent runs
            </div>
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-aab8cefb-7ab8-6e30-db30-6021464efbdc-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-c25032c3-afda-d073-752e-b64ee0d8d54d-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Max agent runtime
            </div>
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-_21c600fc-c243-61b9-5da3-5963810a6bc9-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
...
Custom
        ...
        <div className="pricing_line">
          <div id="w-node-_3f9f810e-84ea-065b-e6be-cb515655de69-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Debugging console
            </div>
          ...
          <div className="u-hflex-center-center gap-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 18 19" fill="none" className="pricing_grid_icon">
              <path d="M15.0186 5.01797C15.3842 5.35547 15.3842 5.94609 15.0186 6.28359L7.81855 13.4836C7.48105 13.8492 6.89043 13.8492 6.55293 13.4836L2.95293 9.88359C2.5873 9.54609 2.5873 8.95547 2.95293 8.61797C3.29043 8.25234 3.88105 8.25234 4.21855 8.61797L7.1998 11.5711L13.7529 5.01797C14.0904 4.65234 14.6811 4.65234 15.0186 5.01797Z" fill="#6860FF"></path>
            </svg>
          </div>
          <div className="u-hflex-center-center gap-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 18 19" fill="none" className="pricing_grid_icon">
        ...
        <div className="pricing_line">
          <div id="w-node-_373500f5-6a27-de60-771a-e9169afff772-9296596a" className="u-hflex-left-center gap-icon">
            <div className="u-text-medium fw-medium op70">
Add-ons
            </div>
          </div>
          <div className="u-hflex-center-center gap-icon"></div>
          <div className="u-hflex-center-center gap-icon"></div>
          <div className="u-hflex-center-center gap-icon"></div>
          <div className="u-hflex-center-center gap-icon">
            <div className="u-text-medium fw-medium is--small">
