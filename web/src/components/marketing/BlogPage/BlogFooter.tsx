...
const SOCIAL_LINKS = [
  {
    href: "https://www.linkedin.com/company/vellumai",
    label: "LinkedIn",
    icon: (
...
const FOOTER_COLUMNS = [
  ...
  },
  {
    title: "Company",
    links: [
      { label: "Careers", href: "https://jobs.ashbyhq.com/vellum", external: true },
        ...
        <div className="container-new new">
          <div className="cta_home-head text-wrap-balance">
            ...
            <div className="button-group is-center">
              <a href="/signup" className="d-button nav-button-5 js-utm-signup cta-get-started new large w-inline-block">
              ...
              <div className="footer_social-wrap">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    rel="noreferrer"
                  >
                    <div className="icon-embed-small smaller w-embed">
                      {social.icon}
                    </div>
                  </a>
                ))}
            ...
            <div className="footer_bottom-wrap">
              <div className="footer_subgrid grid-4 font-inter">
                {FOOTER_COLUMNS.map((column) => (
                  <div key={column.title} className="u-vflex-stretch-top gap-main">
                    <div className="footer_head_text alt">{column.title}</div>
                    {column.title === "Company" ? (
                      <>
                        <a
                          ...
                          rel="noreferrer"
                        >
                          <div className="footer_link_text alt">{column.links[0].label}</div>
                        </a>
