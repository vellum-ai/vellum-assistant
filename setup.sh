...
if [ -f "${HOME}/.bashrc" ]; then
  if ! grep -q '.vellum/completions.bash' "${HOME}/.bashrc"; then
    printf '\n# vellum completions\nsource ~/.vellum/completions.bash\n' >> "${HOME}/.bashrc"
  fi
fi

if [ -f "${HOME}/.zshrc" ]; then
  if ! grep -q '.vellum/completions.zsh' "${HOME}/.zshrc"; then
    printf '\n# vellum completions\nsource ~/.vellum/completions.zsh\n' >> "${HOME}/.zshrc"
  fi
fi
