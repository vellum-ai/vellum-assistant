...
const MANAGER_API_STUB =
  ...
  // useArgs returns the args of the story currently rendering, published by
  // compose() in the preview wrapper. Storybook's controlled-input pattern
  // (`const [{ value }] = useArgs()`) overrides the merged arg with this
  // return value, so an unconditional {} renders every controlled component
  // valueless while the storybook reference shows it correctly.
  'const dsArgs=function(){return(typeof globalThis!=="undefined"&&globalThis.__dsStoryArgs)||{}};' +
  'module.exports={addons,types:{},useGlobals(){return[{},function(){}]},useArgs(){return[dsArgs(),function(){},function(){}]},useParameter(){},useStorybookApi(){return{}},' +
