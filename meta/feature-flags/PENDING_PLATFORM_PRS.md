...
| `system-schedule-toggles` | 2026-06-05 | schedules owner | Platform PR not yet opened (as of 2026-06-05) | Terraform entry in `../vellum-assistant-platform/terraform/launchdarkly.tf` (or equivalent) with `defaultEnabled: false` provisioning the schedules-page system job toggle rollout. |
