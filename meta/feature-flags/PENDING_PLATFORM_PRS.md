...
| `voice-mode-hands-free` | 2026-07-06 | live-voice owner | Platform PR not yet opened (as of 2026-07-06) | Terraform entry in `../vellum-assistant-platform/terraform/launchdarkly.tf` (or equivalent) with `defaultEnabled: false` provisioning the `voice-mode-hands-free` assistant flag, which switches live-voice sessions to server-side turn detection and barge-in (hands-free, multi-turn). |
