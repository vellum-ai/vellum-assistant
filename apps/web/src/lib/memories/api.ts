...
// /v1/assistants/{id}/memory-items/* and are not part of the Django OpenAPI
// schema, so no generated HeyAPI hooks exist for them. Mirrors the pattern used
// by web/src/lib/skills/api.ts.
...
import type { MemoryItem, MemoryItemsListResponse } from "@/lib/memories/types.js";
