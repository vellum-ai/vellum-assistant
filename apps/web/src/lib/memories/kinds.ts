...
import type { MemoryKind } from "@/lib/memories/types.js";
...
// Fun palette hex values — keep in sync with macOS VColor.fun* tokens.
const FUN_COLORS = {
  pink: "#DB4B77",
  teal: "#0E9B8B",
  red: "#EF4400",
...
// Sidebar ordering matches the desktop panel: Event, Knowledge, Feeling, Plan,
// Pattern, Story, Shared. Procedural (Skill) is excluded — it's system-managed
// and surfaced on the Skills tab instead.
...
// Kinds a user may pick when editing. Matches macOS userCreatableKinds.
