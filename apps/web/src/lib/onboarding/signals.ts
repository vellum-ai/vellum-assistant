 ...
 *
 * **Client-only module.** The module-scoped state would be shared across
 * requests if this were imported from a server component. Both existing
 * callers are `"use client"` screens — keep it that way.
 */
