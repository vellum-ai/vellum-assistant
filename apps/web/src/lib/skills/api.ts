...
// assistant daemon via RuntimeProxyWildcardView under /v1/assistants/{id}/skills/*
// and are not part of the Django OpenAPI schema, so no generated HeyAPI hooks
// exist for them. Keep this file thin; once the daemon endpoints are added to
// the schema, migrate to the autogenerated tanstack-query hooks.
