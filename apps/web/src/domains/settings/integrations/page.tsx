...
import { IntegrationDetailModal } from "@/components/app/settings/integration-detail-modal.js";
import { IntegrationRow } from "@/components/app/settings/IntegrationRow.js";
...
} from "@/lib/assistants/oauth-providers.js";
...
function IntegrationsPanelInner() {
  ...
  useEffect(() => {
    ...
    replace(routes.settings.integrations);
