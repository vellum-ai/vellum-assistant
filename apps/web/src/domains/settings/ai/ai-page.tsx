...
import { EmailServiceCard } from "@/domains/settings/ai/email-card";
...
import { SpeechToTextCard } from "@/domains/settings/ai/stt-card";
import { TextToSpeechCard } from "@/domains/settings/ai/tts-card";
...
export function AiPage() {
  ...
  // Scroll to hash target on mount (e.g. /settings/ai#email)
  useEffect(() => {
