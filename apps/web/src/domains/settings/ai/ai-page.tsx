...
// Re-exports so existing external importers keep working.
export type { ProfileEntry, DaemonConfigReconciliation, InferenceTokenBudgetState } from "@/domains/settings/ai/ai-types";
export {
  INFERENCE_PROVIDERS,
...
// ---------------------------------------------------------------------------
// Email card — kept in ai-page.tsx because it is already self-contained and
// exported for external consumption (tests, route lazy loaders).
// ---------------------------------------------------------------------------
