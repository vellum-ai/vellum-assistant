...
import { getDefaultModelForProvider, getModelsForProvider } from "@/lib/llm-model-catalog.js";

import { INFERENCE_PROVIDER_DISPLAY_NAMES, INFERENCE_PROVIDERS } from "@/domains/settings/ai/page.js";
import {
  profilePickerLabel,
...
function CallSiteOverridesModalInner({
  ...
  function handleToggle(id: string, on: boolean) {
    ...
    if (firstActiveProfileName) {
      setDrafts((prev) => ({ ...prev, [id]: { profile: firstActiveProfileName } }));
    } else {
                        ...
                        >
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div className="flex shrink-0 items-center gap-2">
                              ...
                              <Toggle
                                checked={overrideOn}
                                onChange={(on) => handleToggle(cs.id, on)}
