...
import type { OpenedDocumentState } from "@/domains/chat/lib/viewer-state.js";
 ...
 * surface referenced from chat. Rendered through
 * `AssistantShell.viewportOverlays` so it lives as a sibling of the shell's
 * transformed inner wrapper — keeping its `position: fixed` box anchored to
 * the viewport's initial containing block rather than the keyboard-following
 * shell transform.
 *
