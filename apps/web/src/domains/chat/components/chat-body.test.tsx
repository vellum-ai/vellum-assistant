...
mock.module(
  "@/domains/chat/components/maintenance-recovery-card.js",
  () => ({
    MaintenanceRecoveryCard: () => <div>MAINTENANCE</div>,
  }),
);

mock.module("@/components/app/assistant/ChatSkeleton.js", () => ({
  ChatSkeleton: () => <div>SKELETON</div>,
}));

mock.module(
  "@/domains/chat/components/scroll-to-latest-button.js",
  () => ({
...
mock.module(
  "@/components/app/assistant/ChatComposer/ChatComposer.js",
  () => ({
    ChatComposer: () => <div data-testid="composer">COMPOSER</div>,
  }),
);

mock.module("@/components/app/core/Notice/Notice", () => ({
