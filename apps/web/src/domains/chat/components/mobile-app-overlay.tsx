...
import type { OpenedAppState } from "@/domains/chat/lib/viewer-state.js";
 ...
 * again.
 *
 * Rendered through `AssistantShell.viewportOverlays`, which places it as a
 * sibling of the shell's transformed inner wrapper. That sibling position
 * keeps `position: fixed` anchored to the viewport's initial containing
 * block rather than the keyboard-following shell transform.
 *
