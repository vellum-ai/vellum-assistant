...
import { useSubagentDetail } from "@/domains/chat/hooks/use-subagent-detail";
import { useChatHeaderSlots } from "@/domains/chat/hooks/use-chat-header-slots";
...
export function ChatPage() {
  ...
  // -------------------------------------------------------------------------
  const { handleRequestSubagentDetail } = useSubagentDetail({
    assistantId,
    activeConversationId,
  });
  ...
  // -------------------------------------------------------------------------
  // Layout header slots (conversation title + assets pill)
  // -------------------------------------------------------------------------
  useChatHeaderSlots({
    assistantId,
    activeConversation,
