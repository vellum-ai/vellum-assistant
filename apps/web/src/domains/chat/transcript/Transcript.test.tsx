...
mock.module("@/components/assistant/MarkdownMessage.js", () => ({
...
// sentinel.
mock.module("@/components/assistant/surfaces/index.js", () => ({
...
mock.module("@/components/assistant/MessageHoverActions/index.js", () => ({
  MessageHoverActions: () => <div data-testid="hover-actions" />,
}));

mock.module("@/components/assistant/ToolCallChip/index.js", () => ({
  ToolCallChip: () => <div data-testid="tool-call" />,
}));

mock.module("@/components/app/assistant/ChatAttachments/index.js", () => ({
