  ...
  return (
    <OnboardingLayout>
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col items-center justify-center px-6 pb-40 text-center">
        ...
        {/* typography: off-scale — hero onboarding h1 (30px) intentionally larger than text-title-large (24px) to match onboarding visual weight */}
        <h1
