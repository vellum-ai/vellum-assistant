 ...
 * (`useTurnStore.use.phase()`, `useTurnStore.use.requestSend()`, etc.).
 * Non-React code (stream handlers, reconciliation) reads the latest state
 * synchronously via `useTurnStore.getState()`.
 *
 * References:
