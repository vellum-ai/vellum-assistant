...
import { BusyIndicator } from "@/components/assistant/BusyIndicator.js";
import {
  AlertCircle,
  Camera,
  CheckCircle2,
...
import {
  ...
  friendlyToolIcon,
  friendlyToolLabel,
} from "@/components/assistant/ToolCallChip/utils.js";
...
export function ToolCallChip({
  ...
  }, [toolCall.pendingConfirmation, isActiveConfirmation]);
