...
import { searchEmoji, type EmojiEntry } from "@/components/chat-composer/emoji-catalog.js";
import { filteredCommands, type SlashCommand } from "@/components/chat-composer/slash-command-catalog.js";
