...
/** Strip a trailing `.00` so whole numbers render as `5` instead of `5.00`. */
...
// Inner component unmounts on close, so transient state (copied pill,
// terms-view flag) resets naturally without a useEffect.
