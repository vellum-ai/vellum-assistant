...
/**
 * User-facing toggle controlling whether Vellum administrators have privileged
 * access to assistant data (today: tailing the daemon log file at
 * ``/workspace/data/logs/vellum.log`` from the assistant pod). The flag
 * defaults to off, so admins cannot reach this data unless the owner
 * explicitly opts in for support / debugging purposes.
 */
    ...
    <div className="flex items-start justify-between gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <Toggle
          ...
          aria-label="Allow admin access to assistant data"
        />
      </div>
    </div>
  );
