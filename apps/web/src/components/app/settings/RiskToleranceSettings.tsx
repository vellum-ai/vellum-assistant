  ...
  useEffect(() => {
    return () => {
      if (saveTimerRef.current !== null) {
        ...
        // Flush pending save synchronously so the user's most recent change is
        // not silently dropped if they navigate away within the 500ms window.
        // setGlobalThresholds + queryClient.invalidateQueries are both safe to
        // call after unmount (no setState on this component).
  ...
  return (
    <Card>
      ...
      <div className="mt-4 space-y-4">
        {/* Conversations (interactive) — always visible */}
        <div>
        ...
        {/* Advanced — Background + Headless thresholds */}
        <div>
          <button
            type="button"
