...
import { useLlmLogPayload } from "@/domains/chat/lib/inspector-payload-api.js";
...
/**
 * Raw tab — web-native equivalent of macOS's `rawPayloadTab`.
 *
 * Lazily fetches the full provider JSON for the selected call. Exposes
 * a Request/Response toggle, copy action, and download action for each pane.
 * Payloads are cached for 5 minutes (they never mutate).
 */
