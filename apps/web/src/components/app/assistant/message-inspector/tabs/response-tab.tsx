...
/**
 * Response tab — web port of `MessageInspectorResponseTab.swift`.
 *
 * Renders a metadata card (stop reason + mode label) followed by
 * per-section cards keyed on presentation kind. Falls back to a single
 * explanatory card when sections are empty or unavailable.
 */
