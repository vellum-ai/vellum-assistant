...
/**
 * Horizontal tab bar for the inspector detail pane. Web port of the
 * `VTabs` segment used in `MessageInspectorView.swift`. Memory tab is
 * intentionally omitted here — it lands in the follow-up PR.
 */
