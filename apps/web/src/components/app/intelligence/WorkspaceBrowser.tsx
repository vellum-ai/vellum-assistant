...
import { WorkspaceFileViewer } from "@/components/app/intelligence/WorkspaceFileViewer.js";
import { WorkspaceTree } from "@/components/app/intelligence/WorkspaceTree.js";
...
export function WorkspaceBrowser({ assistantId }: { assistantId: string }) {
  ...
  const treeProps = {
    ...
    onToggleShowHidden: () => setShowHidden((v: boolean) => !v),
  };
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-4">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 sm:grid-cols-[320px_1fr]">
        <div
          className="hidden min-h-0 min-w-0 flex-col overflow-hidden rounded-xl sm:flex"
          style={{
