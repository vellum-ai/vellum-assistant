...
function TreeNode({
  ...
  // Expand directories whose names match during search, so their children
  // (if any match) are visible to the filter below.
  ...
  // their children can mount, fetch, and reveal deeply nested matches — the
  // intermediate directories don't need to match on their own name.
...
// ---------------------------------------------------------------------------
// WorkspaceTreeCreateMenu — desktop popover / mobile bottom-sheet wrapper
// for the "New File / New Folder" action menu rendered next to the Files
// header. Extracted so the mobile vs desktop branch can be unit-tested
// without standing up the parent's queries and mutations.
// ---------------------------------------------------------------------------
      ...
      <BottomSheet.Root open={open} onOpenChange={onOpenChange}>
        ...
        <BottomSheet.Content>
          {/* Radix Dialog requires a Title for screen readers — visually-hidden
              since this menu's two rows are self-describing. */}
