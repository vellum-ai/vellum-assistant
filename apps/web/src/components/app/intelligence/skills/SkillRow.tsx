...
import { SkillOriginBadge } from "@/components/app/intelligence/skills/SkillOriginBadge.js";
...
export function SkillRow({
  ...
  return (
    <Card.Root asChild>
      ...
      >
      { }
      <div className={"flex h-10 w-10 shrink-0 items-center justify-center text-2xl" /* typography: off-scale — emoji/icon size */}>
        {skill.emoji ?? "🧩"}
      </div>
