...
import { NodeShell, type NodeShellVariant } from "@/components/app/intelligence/identity/ConstellationView/_NodeShell.js";
import { SkillNode } from "@/components/app/intelligence/identity/ConstellationView/_SkillNode.js";
import { nodeDelay, nodeVisibility } from "@/components/app/intelligence/identity/ConstellationView/utils.js";
  ...
  if (node.kind.type === "category" || node.kind.type === "subCategory") {
    ...
    const labelClass =
      variant === "category"
        ...
        :  
          "mt-0.5 max-w-[85%] truncate text-[9.5px] font-medium leading-tight text-[var(--content-default)]" /* typography: off-scale — 9.5px fitted to geometric shape */;
    return (
      <NodeShell
        variant={variant}
        x={node.x}
