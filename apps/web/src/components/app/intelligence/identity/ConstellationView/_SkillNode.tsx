...
import { SKILL_NODE_SIZE } from "@/components/app/intelligence/identity/constellationLayout.js";
import type { OrbitItem } from "@/components/app/intelligence/identity/constellationLayout.js";

import { NODE_SPRING } from "@/components/app/intelligence/identity/ConstellationView/constants.js";
import { useNodeClickHandlers } from "@/components/app/intelligence/identity/ConstellationView/hooks/useNodeClickHandlers.js";
import { mixedBg, type NodeVisibility } from "@/components/app/intelligence/identity/ConstellationView/utils.js";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className={"text-[16px] leading-none" /* typography: off-scale — 16px off-scale */} aria-hidden>
          {item.emoji ?? fallbackEmoji}
        </span>
        <span
           
          className={"mt-0.5 max-w-[42px] truncate text-[9px] font-medium leading-tight text-[var(--content-default)]" /* typography: off-scale — 9px off-scale */}
          title={item.label}
        >
          {item.label}
        </span>
