...
**Hidden channels** (`ADMISSION_POLICY_HIDDEN_CHANNELS` = `vellum`, `whatsapp`, `connections`) are managed automatically and **not** user-configurable, but (unlike exempt channels) are **still enforced at runtime**:
