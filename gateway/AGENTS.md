...
- **`conversationExternalId`**: Delivery/thread address (e.g., Telegram chat ID, WhatsApp phone number). Used for conversation binding and message routing. **Not** used for trust classification.
