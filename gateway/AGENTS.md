...
**Hidden channels** (`ADMISSION_POLICY_HIDDEN_CHANNELS` = `vellum`, `whatsapp`, `connections`) — managed automatically, **not** user-configurable, but (unlike exempt channels) **still enforced at runtime**:
