...
| `services.stt.language`           | string   | _(unset)_                                               | Spoken language for transcription (BCP-47 code, or unset for the provider's multilingual default). Per-language TTS voices are configured via `services.tts.providers.<id>.languageVoices`. |
