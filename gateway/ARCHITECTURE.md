...
The ingress membership system extends the guardian security model to support controlled cross-user access. External users interact with the assistant through channels (Telegram) under an invite-based membership system with per-member access policies.
