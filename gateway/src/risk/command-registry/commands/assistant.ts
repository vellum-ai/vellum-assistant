...
const ASSISTANT_SUPPORTED_COMMAND_PATHS = [
  ...
  "inference connections create",
  "inference connections delete",
  "inference connections get",
  "inference connections list",
  "inference connections update",
  "inference send",
  "inference session",
