...
const ASSISTANT_SUPPORTED_COMMAND_PATHS = [
  ...
  "contacts get",
  "contacts prompt",
  "contacts workspace-commands",
  "contacts workspace-commands get",
  "contacts workspace-commands allow",
  "contacts workspace-commands deny",
  "contacts channels",
...
const riskOverrides: AssistantRiskOverride[] = [
  ...
  { path: "contacts workspace-commands get", risk: "low" },
  {
    path: "contacts workspace-commands allow",
    risk: "high",
    reason:
      "Grants a trusted contact standing workspace shell access in their conversations",
  },
  {
    path: "contacts workspace-commands deny",
    risk: "medium",
    reason: "Revokes standing workspace shell access for a trusted contact",
  },
