/**
 * Tests for m0011-migrate-slack-channel-permissions.
 *
...
import { up } from "../db/data-migrations/m0011-migrate-slack-channel-permissions.js";
...
describe("m0011-migrate-slack-channel-permissions", () => {
