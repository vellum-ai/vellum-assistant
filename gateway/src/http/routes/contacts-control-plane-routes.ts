...
const UpsertContactChannelInputSchema = z.object({
  ...
  externalChatId: z
    ...
    .optional()
    .describe(
      "Delivery chat id. Omit to preserve the stored value; clearing is not supported (a stored null is indistinguishable from never-learned, so no consumer could tell a clear from a gap).",
    ),
